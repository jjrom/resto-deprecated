...
!0):k.support.deleteExpando||h!=h.window?delete h[j]:h[j]=null)}}}function f(a,c,d){if(d===b&&1===a.nodeType){var e="data-"+c.replace(Fc,"-$1").toLowerCase();if(d=a.getAttribute(e),"string"==typeof d){try{d="true"===d?!0:"false"===d?!1:"null"===d?null:+d+""===d?+d:Gc.test(d)?k.parseJSON(d):d}catch(f){}k.data(a,c,d)}else d=b}return d}function g(a){for(var b in a)if(("data"!==b||!k.isEmptyObject(a[b]))&&"toJSON"!==b)return!1;return!0}function h(){return!0}function j(){return!1}function n(){try{return A.activeElement}catch(a){}}
function p(a,b){do a=a[b];while(a&&1!==a.nodeType);return a}function q(a,b,c){if(k.isFunction(b))return k.grep(a,function(a,d){return!!b.call(a,d,a)!==c});if(b.nodeType)return k.grep(a,function(a){return a===b!==c});if("string"==typeof b){if(Hc.test(b))return k.filter(b,a,c);b=k.filter(b,a)}return k.grep(a,function(a){return 0<=k.inArray(a,b)!==c})}function m(a){var b=Tb.split("|"),a=a.createDocumentFragment();if(a.createElement)for(;b.length;)a.createElement(b.pop());return a}function s(a,b){return k.nodeName(a,
"table")&&k.nodeName(1===b.nodeType?b:b.firstChild,"tr")?a.getElementsByTagName("tbody")[0]||a.appendChild(a.ownerDocument.createElement("tbody")):a}function r(a){return a.type=(null!==k.find.attr(a,"type"))+"/"+a.type,a}function u(a){var b=Ic.exec(a.type);return b?a.type=b[1]:a.removeAttribute("type"),a}function v(a,b){for(var c,d=0;null!=(c=a[d]);d++)k._data(c,"globalEval",!b||k._data(b[d],"globalEval"))}function t(a,b){if(1===b.nodeType&&k.hasData(a)){var c,d,e;d=k._data(a);var f=k._data(b,d),
h=d.events;if(h)for(c in delete f.handle,f.events={},h){d=0;for(e=h[c].length;e>d;d++)k.event.add(b,c,h[c][d])}f.data&&(f.data=k.extend({},f.data))}}function w(a,c){var d,e,f=0,h=typeof a.getElementsByTagName!==F?a.getElementsByTagName(c||"*"):typeof a.querySelectorAll!==F?a.querySelectorAll(c||"*"):b;if(!h){h=[];for(d=a.childNodes||a;null!=(e=d[f]);f++)!c||k.nodeName(e,c)?h.push(e):k.merge(h,w(e,c))}return c===b||c&&k.nodeName(a,c)?k.merge([a],h):h}function y(a){pb.test(a.type)&&(a.defaultChecked=
a.checked)}function B(a,b){if(b in a)return b;for(var c=b.charAt(0).toUpperCase()+b.slice(1),d=b,e=Ub.length;e--;)if(b=Ub[e]+c,b in a)return b;return d}function C(a,b){return a=b||a,"none"===k.css(a,"display")||!k.contains(a.ownerDocument,a)}function x(a,b){for(var c,d,e,f=[],h=0,j=a.length;j>h;h++)d=a[h],d.style&&(f[h]=k._data(d,"olddisplay"),c=d.style.display,b?(f[h]||"none"!==c||(d.style.display=""),""===d.style.display&&C(d)&&(f[h]=k._data(d,"olddisplay",U(d.nodeName)))):f[h]||(e=C(d),(c&&"none"!==
c||!e)&&k._data(d,"olddisplay",e?c:k.css(d,"display"))));for(h=0;j>h;h++)d=a[h],d.style&&(b&&"none"!==d.style.display&&""!==d.style.display||(d.style.display=b?f[h]||"":"none"));return a}function N(a,b,c){return(a=Jc.exec(b))?Math.max(0,a[1]-(c||0))+(a[2]||"px"):b}function O(a,b,c,d,e){for(var b=c===(d?"border":"content")?4:"width"===b?1:0,f=0;4>b;b+=2)"margin"===c&&(f+=k.css(a,c+ya[b],!0,e)),d?("content"===c&&(f-=k.css(a,"padding"+ya[b],!0,e)),"margin"!==c&&(f-=k.css(a,"border"+ya[b]+"Width",!0,
e))):(f+=k.css(a,"padding"+ya[b],!0,e),"padding"!==c&&(f+=k.css(a,"border"+ya[b]+"Width",!0,e)));return f}function z(a,b,c){var d=!0,e="width"===b?a.offsetWidth:a.offsetHeight,f=za(a),h=k.support.boxSizing&&"border-box"===k.css(a,"boxSizing",!1,f);if(0>=e||null==e){if(e=Aa(a,b,f),(0>e||null==e)&&(e=a.style[b]),Xa.test(e))return e;d=h&&(k.support.boxSizingReliable||e===a.style[b]);e=parseFloat(e)||0}return e+O(a,b,c||(h?"border":"content"),d,f)+"px"}function U(a){var b=A,c=Vb[a];return c||(c=aa(a,
b),"none"!==c&&c||(Qa=(Qa||k("<iframe frameborder='0' width='0' height='0'/>").css("cssText","display:block !important")).appendTo(b.documentElement),b=(Qa[0].contentWindow||Qa[0].contentDocument).document,b.write("<!doctype html><html><body>"),b.close(),c=aa(a,b),Qa.detach()),Vb[a]=c),c}function aa(a,b){var c=k(b.createElement(a)).appendTo(b.body),d=k.css(c[0],"display");return c.remove(),d}function Ra(a,b,c,d){var e;if(k.isArray(b))k.each(b,function(b,e){c||Kc.test(a)?d(a,e):Ra(a+"["+("object"==
typeof e?b:"")+"]",e,c,d)});else if(c||"object"!==k.type(b))d(a,b);else for(e in b)Ra(a+"["+e+"]",b[e],c,d)}function ha(a){return function(b,c){"string"!=typeof b&&(c=b,b="*");var d,e=0,f=b.toLowerCase().match(ma)||[];if(k.isFunction(c))for(;d=f[e++];)"+"===d[0]?(d=d.slice(1)||"*",(a[d]=a[d]||[]).unshift(c)):(a[d]=a[d]||[]).push(c)}}function Q(a,c,d,e){function f(g){var n;return h[g]=!0,k.each(a[g]||[],function(a,J){var g=J(c,d,e);return"string"!=typeof g||j||h[g]?j?!(n=g):b:(c.dataTypes.unshift(g),
f(g),!1)}),n}var h={},j=a===qb;return f(c.dataTypes[0])||!h["*"]&&f("*")}function ba(a,c){var d,e,f=k.ajaxSettings.flatOptions||{};for(e in c)c[e]!==b&&((f[e]?a:d||(d={}))[e]=c[e]);return d&&k.extend(!0,a,d),a}function X(){try{return new a.XMLHttpRequest}catch(b){}}function qa(){return setTimeout(function(){Ka=b}),Ka=k.now()}function Sa(a,b,c){for(var d,e=(Ta[b]||[]).concat(Ta["*"]),f=0,h=e.length;h>f;f++)if(d=e[f].call(c,b,a))return d}function R(a,b,c){var d,e,f=0,h=Ya.length,j=k.Deferred().always(function(){delete g.elem}),
g=function(){if(e)return!1;for(var b=Ka||qa(),b=Math.max(0,n.startTime+n.duration-b),c=1-(b/n.duration||0),d=0,f=n.tweens.length;f>d;d++)n.tweens[d].run(c);return j.notifyWith(a,[n,c,b]),1>c&&f?b:(j.resolveWith(a,[n]),!1)},n=j.promise({elem:a,props:k.extend({},b),opts:k.extend(!0,{specialEasing:{}},c),originalProperties:b,originalOptions:c,startTime:Ka||qa(),duration:c.duration,tweens:[],createTween:function(b,c){var d=k.Tween(a,n.opts,b,c,n.opts.specialEasing[b]||n.opts.easing);return n.tweens.push(d),
d},stop:function(b){var c=0,d=b?n.tweens.length:0;if(e)return this;for(e=!0;d>c;c++)n.tweens[c].run(1);return b?j.resolveWith(a,[n,b]):j.rejectWith(a,[n,b]),this}}),b=n.props,c=n.opts.specialEasing,p,m,q,t;for(d in b)if(p=k.camelCase(d),m=c[p],q=b[d],k.isArray(q)&&(m=q[1],q=b[d]=q[0]),d!==p&&(b[p]=q,delete b[d]),t=k.cssHooks[p],t&&"expand"in t)for(d in q=t.expand(q),delete b[p],q)d in b||(b[d]=q[d],c[d]=m);else c[p]=m;for(;h>f;f++)if(d=Ya[f].call(n,a,b,n.opts))return d;return k.map(b,Sa,n),k.isFunction(n.opts.start)&&
n.opts.start.call(a,n),k.fx.timer(k.extend(g,{elem:a,anim:n,queue:n.opts.queue})),n.progress(n.opts.progress).done(n.opts.done,n.opts.complete).fail(n.opts.fail).always(n.opts.always)}function G(a,b,c,d,e){return new G.prototype.init(a,b,c,d,e)}function T(a,b){for(var c,d={height:a},e=0,b=b?1:0;4>e;e+=2-b)c=ya[e],d["margin"+c]=d["padding"+c]=a;return b&&(d.opacity=d.width=a),d}function K(a){return k.isWindow(a)?a:9===a.nodeType?a.defaultView||a.parentWindow:!1}var na,ra,F=typeof b,ca=a.location,A=
a.document,Wb=A.documentElement,Mc=a.jQuery,Nc=a.$,Za={},Ja=[],Xb=Ja.concat,rb=Ja.push,Ba=Ja.slice,Yb=Ja.indexOf,Oc=Za.toString,La=Za.hasOwnProperty,sb="1.10.2".trim,k=function(a,b){return new k.fn.init(a,b,ra)},$a=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,ma=/\S+/g,Pc=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,Qc=/^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/,Zb=/^<(\w+)\s*\/?>(?:<\/\1>|)$/,Rc=/^[\],:{}\s]*$/,Sc=/(?:^|:|,)(?:\s*\[)+/g,Tc=/\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g,Uc=/"[^"\\\r\n]*"|true|false|null|-?(?:\d+\.|)\d+(?:[eE][+-]?\d+|)/g,
Vc=/^-ms-/,Wc=/-([\da-z])/gi,Xc=function(a,b){return b.toUpperCase()},sa=function(a){(A.addEventListener||"load"===a.type||"complete"===A.readyState)&&($b(),k.ready())},$b=function(){A.addEventListener?(A.removeEventListener("DOMContentLoaded",sa,!1),a.removeEventListener("load",sa,!1)):(A.detachEvent("onreadystatechange",sa),a.detachEvent("onload",sa))};k.fn=k.prototype={jquery:"1.10.2",constructor:k,init:function(a,c,d){var e,f;if(!a)return this;if("string"==typeof a){if(e="<"===a.charAt(0)&&">"===
a.charAt(a.length-1)&&3<=a.length?[null,a,null]:Qc.exec(a),!e||!e[1]&&c)return!c||c.jquery?(c||d).find(a):this.constructor(c).find(a);if(e[1]){if(c=c instanceof k?c[0]:c,k.merge(this,k.parseHTML(e[1],c&&c.nodeType?c.ownerDocument||c:A,!0)),Zb.test(e[1])&&k.isPlainObject(c))for(e in c)k.isFunction(this[e])?this[e](c[e]):this.attr(e,c[e]);return this}if(f=A.getElementById(e[2]),f&&f.parentNode){if(f.id!==e[2])return d.find(a);this.length=1;this[0]=f}return this.context=A,this.selector=a,this}return a.nodeType?
(this.context=this[0]=a,this.length=1,this):k.isFunction(a)?d.ready(a):(a.selector!==b&&(this.selector=a.selector,this.context=a.context),k.makeArray(a,this))},selector:"",length:0,toArray:function(){return Ba.call(this)},get:function(a){return null==a?this.toArray():0>a?this[this.length+a]:this[a]},pushStack:function(a){a=k.merge(this.constructor(),a);return a.prevObject=this,a.context=this.context,a},each:function(a,b){return k.each(this,a,b)},ready:function(a){return k.ready.promise().done(a),
this},slice:function(){return this.pushStack(Ba.apply(this,arguments))},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},eq:function(a){var b=this.length,a=+a+(0>a?b:0);return this.pushStack(0<=a&&b>a?[this[a]]:[])},map:function(a){return this.pushStack(k.map(this,function(b,c){return a.call(b,c,b)}))},end:function(){return this.prevObject||this.constructor(null)},push:rb,sort:[].sort,splice:[].splice};k.fn.init.prototype=k.fn;k.extend=k.fn.extend=function(){var a,c,d,e,f,h,
...
Nc),b&&a.jQuery===k&&(a.jQuery=Mc),k},isReady:!1,readyWait:1,holdReady:function(a){a?k.readyWait++:k.ready(!0)},ready:function(a){if(!0===a?!--k.readyWait:!k.isReady){if(!A.body)return setTimeout(k.ready);k.isReady=!0;!0!==a&&0<--k.readyWait||(na.resolveWith(A,[k]),k.fn.trigger&&k(A).trigger("ready").off("ready"))}},isFunction:function(a){return"function"===k.type(a)},isArray:Array.isArray||function(a){return"array"===k.type(a)},isWindow:function(a){return null!=a&&a==a.window},isNumeric:function(a){return!isNaN(parseFloat(a))&&
isFinite(a)},type:function(a){return null==a?a+"":"object"==typeof a||"function"==typeof a?Za[Oc.call(a)]||"object":typeof a},isPlainObject:function(a){var c;if(!a||"object"!==k.type(a)||a.nodeType||k.isWindow(a))return!1;try{if(a.constructor&&!La.call(a,"constructor")&&!La.call(a.constructor.prototype,"isPrototypeOf"))return!1}catch(d){return!1}if(k.support.ownLast)for(c in a)return La.call(a,c);for(c in a);return c===b||La.call(a,c)},isEmptyObject:function(a){for(var b in a)return!1;return!0},error:function(a){throw Error(a);
},parseHTML:function(a,b,c){if(!a||"string"!=typeof a)return null;"boolean"==typeof b&&(c=b,b=!1);var b=b||A,d=Zb.exec(a),c=!c&&[];return d?[b.createElement(d[1])]:(d=k.buildFragment([a],b,c),c&&k(c).remove(),k.merge([],d.childNodes))},parseJSON:function(c){return a.JSON&&a.JSON.parse?a.JSON.parse(c):null===c?c:"string"==typeof c&&(c=k.trim(c),c&&Rc.test(c.replace(Tc,"@").replace(Uc,"]").replace(Sc,"")))?Function("return "+c)():(k.error("Invalid JSON: "+c),b)},parseXML:function(c){var d,e;if(!c||
"string"!=typeof c)return null;try{a.DOMParser?(e=new DOMParser,d=e.parseFromString(c,"text/xml")):(d=new ActiveXObject("Microsoft.XMLDOM"),d.async="false",d.loadXML(c))}catch(f){d=b}return d&&d.documentElement&&!d.getElementsByTagName("parsererror").length||k.error("Invalid XML: "+c),d},noop:function(){},globalEval:function(b){b&&k.trim(b)&&(a.execScript||function(b){a.eval.call(a,b)})(b)},camelCase:function(a){return a.replace(Vc,"ms-").replace(Wc,Xc)},nodeName:function(a,b){return a.nodeName&&
a.nodeName.toLowerCase()===b.toLowerCase()},each:function(a,b,d){var e,f=0,h=a.length,j=c(a);if(d)if(j)for(;h>f&&!(e=b.apply(a[f],d),!1===e);f++);else for(f in a){if(e=b.apply(a[f],d),!1===e)break}else if(j)for(;h>f&&!(e=b.call(a[f],f,a[f]),!1===e);f++);else for(f in a)if(e=b.call(a[f],f,a[f]),!1===e)break;return a},trim:sb&&!sb.call("\ufeff\u00a0")?function(a){return null==a?"":sb.call(a)}:function(a){return null==a?"":(a+"").replace(Pc,"")},makeArray:function(a,b){var d=b||[];return null!=a&&(c(Object(a))?
k.merge(d,"string"==typeof a?[a]:a):rb.call(d,a)),d},inArray:function(a,b,c){var d;if(b){if(Yb)return Yb.call(b,a,c);d=b.length;for(c=c?0>c?Math.max(0,d+c):c:0;d>c;c++)if(c in b&&b[c]===a)return c}return-1},merge:function(a,c){var d=c.length,e=a.length,f=0;if("number"==typeof d)for(;d>f;f++)a[e++]=c[f];else for(;c[f]!==b;)a[e++]=c[f++];return a.length=e,a},grep:function(a,b,c){for(var d,e=[],f=0,h=a.length,c=!!c;h>f;f++)d=!!b(a[f],f),c!==d&&e.push(a[f]);return e},map:function(a,b,d){var e,f=0,h=a.length,
j=[];if(c(a))for(;h>f;f++)e=b(a[f],f,d),null!=e&&(j[j.length]=e);else for(f in a)e=b(a[f],f,d),null!=e&&(j[j.length]=e);return Xb.apply([],j)},guid:1,proxy:function(a,c){var d,e,f;return"string"==typeof c&&(f=a[c],c=a,a=f),k.isFunction(a)?(d=Ba.call(arguments,2),e=function(){return a.apply(c||this,d.concat(Ba.call(arguments)))},e.guid=a.guid=a.guid||k.guid++,e):b},access:function(a,c,d,e,f,h,j){var g=0,n=a.length,p=null==d;if("object"===k.type(d))for(g in f=!0,d)k.access(a,c,g,d[g],!0,h,j);else if(e!==
b&&(f=!0,k.isFunction(e)||(j=!0),p&&(j?(c.call(a,e),c=null):(p=c,c=function(a,b,c){return p.call(k(a),c)})),c))for(;n>g;g++)c(a[g],d,j?e:e.call(a[g],g,c(a[g],d)));return f?a:p?c.call(a):n?c(a[0],d):h},now:function(){return(new Date).getTime()},swap:function(a,b,c,d){var e,f={};for(e in b)f[e]=a.style[e],a.style[e]=b[e];c=c.apply(a,d||[]);for(e in b)a.style[e]=f[e];return c}});k.ready.promise=function(b){if(!na)if(na=k.Deferred(),"complete"===A.readyState)setTimeout(k.ready);else if(A.addEventListener)A.addEventListener("DOMContentLoaded",
sa,!1),a.addEventListener("load",sa,!1);else{A.attachEvent("onreadystatechange",sa);a.attachEvent("onload",sa);var c=!1;try{c=null==a.frameElement&&A.documentElement}catch(d){}c&&c.doScroll&&function W(){if(!k.isReady){try{c.doScroll("left")}catch(a){return setTimeout(W,50)}$b();k.ready()}}()}return na.promise(b)};k.each("Boolean Number String Function Array Date RegExp Object Error".split(" "),function(a,b){Za["[object "+b+"]"]=b.toLowerCase()});ra=k(A);var ub=a,I=function(a,b,c,d){var e,f,h,j,g;
if((b?b.ownerDocument||b:oa)!==Y&&Ca(b),b=b||Y,c=c||[],!a||"string"!=typeof a)return c;if(1!==(j=b.nodeType)&&9!==j)return[];if(ia&&!d){if(e=Yc.exec(a))if(h=e[1])if(9===j){if(f=b.getElementById(h),!f||!f.parentNode)return c;if(f.id===h)return c.push(f),c}else{if(b.ownerDocument&&(f=b.ownerDocument.getElementById(h))&&Ua(b,f)&&f.id===h)return c.push(f),c}else{if(e[2])return ta.apply(c,b.getElementsByTagName(a)),c;if((h=e[3])&&L.getElementsByClassName&&b.getElementsByClassName)return ta.apply(c,b.getElementsByClassName(h)),
c}if(L.qsa&&(!da||!da.test(a))){if(f=e=S,h=b,g=9===j&&a,1===j&&"object"!==b.nodeName.toLowerCase()){j=ab(a);(e=b.getAttribute("id"))?f=e.replace(Zc,"\\$&"):b.setAttribute("id",f);f="[id='"+f+"'] ";for(h=j.length;h--;)j[h]=f+bb(j[h]);h=vb.test(a)&&b.parentNode||b;g=j.join(",")}if(g)try{return ta.apply(c,h.querySelectorAll(g)),c}catch(n){}finally{e||b.removeAttribute("id")}}}var p;a:{var a=a.replace(cb,"$1"),m,k;f=ab(a);if(!d&&1===f.length){if(p=f[0]=f[0].slice(0),2<p.length&&"ID"===(m=p[0]).type&&
L.getById&&9===b.nodeType&&ia&&H.relative[p[1].type]){if(b=(H.find.ID(m.matches[0].replace(ua,va),b)||[])[0],!b){p=c;break a}a=a.slice(p.shift().value.length)}for(j=db.needsContext.test(a)?0:p.length;j--&&!(m=p[j],H.relative[e=m.type]);)if((k=H.find[e])&&(d=k(m.matches[0].replace(ua,va),vb.test(p[0].type)&&b.parentNode||b))){if(p.splice(j,1),a=d.length&&bb(p),!a){p=(ta.apply(c,d),c);break a}break}}p=(wb(a,f)(d,b,!ia,c,vb.test(a)),c)}return p},xb=function(){function a(c,d){return b.push(c+=" ")>H.cacheLength&&
delete a[b.shift()],a[c]=d}var b=[];return a},fa=function(a){return a[S]=!0,a},ga=function(a){var b=Y.createElement("div");try{return!!a(b)}catch(c){return!1}finally{b.parentNode&&b.parentNode.removeChild(b)}},yb=function(a,b){for(var c=a.split("|"),d=a.length;d--;)H.attrHandle[c[d]]=b},bc=function(a,b){var c=b&&a,d=c&&1===a.nodeType&&1===b.nodeType&&(~b.sourceIndex||ac)-(~a.sourceIndex||ac);if(d)return d;if(c)for(;c=c.nextSibling;)if(c===b)return-1;return a?1:-1},$c=function(a){return function(b){return"input"===
b.nodeName.toLowerCase()&&b.type===a}},ad=function(a){return function(b){var c=b.nodeName.toLowerCase();return("input"===c||"button"===c)&&b.type===a}},Da=function(a){return fa(function(b){return b=+b,fa(function(c,d){for(var e,f=a([],c.length,b),h=f.length;h--;)c[e=f[h]]&&(c[e]=!(d[e]=c[e]))})})},cc=function(){},ab=function(a,b){var c,d,e,f,h,j,g;if(h=dc[a+" "])return b?0:h.slice(0);h=a;j=[];for(g=H.preFilter;h;){(!c||(d=bd.exec(h)))&&(d&&(h=h.slice(d[0].length)||h),j.push(e=[]));c=!1;(d=cd.exec(h))&&
(c=d.shift(),e.push({value:c,type:d[0].replace(cb," ")}),h=h.slice(c.length));for(f in H.filter)!(d=db[f].exec(h))||g[f]&&!(d=g[f](d))||(c=d.shift(),e.push({value:c,type:f,matches:d}),h=h.slice(c.length));if(!c)break}return b?h.length:h?I.error(a):dc(a,j).slice(0)},bb=function(a){for(var b=0,c=a.length,d="";c>b;b++)d+=a[b].value;return d},zb=function(a,b,c){var d=b.dir,e=c&&"parentNode"===d,f=dd++;return b.first?function(b,c,f){for(;b=b[d];)if(1===b.nodeType||e)return a(b,c,f)}:function(b,c,h){var j,
g,n,p=ja+" "+f;if(h)for(;b=b[d];){if((1===b.nodeType||e)&&a(b,c,h))return!0}else for(;b=b[d];)if(1===b.nodeType||e)if(n=b[S]||(b[S]={}),(g=n[d])&&g[0]===p){if(!0===(j=g[1])||j===eb)return!0===j}else if(g=n[d]=[p],g[1]=a(b,c,h)||eb,!0===g[1])return!0}},Ab=function(a){return 1<a.length?function(b,c,d){for(var e=a.length;e--;)if(!a[e](b,c,d))return!1;return!0}:a[0]},fb=function(a,b,c,d,e){for(var f,h=[],j=0,g=a.length,n=null!=b;g>j;j++)(f=a[j])&&(!c||c(f,d,e))&&(h.push(f),n&&b.push(j));return h},Bb=
function(a,b,c,d,e,f){return d&&!d[S]&&(d=Bb(d)),e&&!e[S]&&(e=Bb(e,f)),fa(function(f,h,j,g){var n,p,m=[],k=[],q=h.length,t;if(!(t=f)){t=b||"*";for(var x=j.nodeType?[j]:j,s=[],ob=0,r=x.length;r>ob;ob++)I(t,x[ob],s);t=s}t=!a||!f&&b?t:fb(t,m,a,j,g);x=c?e||(f?a:q||d)?[]:h:t;if(c&&c(t,x,j,g),d){n=fb(x,k);d(n,[],j,g);for(j=n.length;j--;)(p=n[j])&&(x[k[j]]=!(t[k[j]]=p))}if(f){if(e||a){if(e){n=[];for(j=x.length;j--;)(p=x[j])&&n.push(t[j]=p);e(null,x=[],n,g)}for(j=x.length;j--;)(p=x[j])&&-1<(n=e?Ea.call(f,
p):m[j])&&(f[n]=!(h[n]=p))}}else x=fb(x===h?x.splice(q,x.length):x),e?e(null,h,x,g):ta.apply(h,x)})},Cb=function(a){var b,c,d,e=a.length,f=H.relative[a[0].type];c=f||H.relative[" "];for(var h=f?1:0,j=zb(function(a){return a===b},c,!0),g=zb(function(a){return-1<Ea.call(b,a)},c,!0),n=[function(a,c,d){return!f&&(d||c!==gb)||((b=c).nodeType?j(a,c,d):g(a,c,d))}];e>h;h++)if(c=H.relative[a[h].type])n=[zb(Ab(n),c)];else{if(c=H.filter[a[h].type].apply(null,a[h].matches),c[S]){for(d=++h;e>d&&!H.relative[a[d].type];d++);
return Bb(1<h&&Ab(n),1<h&&bb(a.slice(0,h-1).concat({value:" "===a[h-2].type?"*":""})).replace(cb,"$1"),c,d>h&&Cb(a.slice(h,d)),e>d&&Cb(a=a.slice(d)),e>d&&bb(a))}n.push(c)}return Ab(n)},Ma,L,eb,H,hb,ec,wb,gb,Fa,Ca,Y,ka,ia,da,Ga,ib,Ua,S="sizzle"+-new Date,oa=ub.document,ja=0,dd=0,fc=xb(),dc=xb(),gc=xb(),Na=!1,Db=function(a,b){return a===b?(Na=!0,0):0},ac=-2147483648,ed={}.hasOwnProperty,wa=[],fd=wa.pop,gd=wa.push,ta=wa.push,hc=wa.slice,Ea=wa.indexOf||function(a){for(var b=0,c=this.length;c>b;b++)if(this[b]===
a)return b;return-1},ic="(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+".replace("w","w#"),jc="\\[[\\x20\\t\\r\\n\\f]*((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)[\\x20\\t\\r\\n\\f]*(?:([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|("+ic+")|)|)[\\x20\\t\\r\\n\\f]*\\]",Eb=":((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|"+jc.replace(3,8)+")*)|.*)\\)|)",cb=RegExp("^[\\x20\\t\\r\\n\\f]+|((?:^|[^\\\\])(?:\\\\.)*)[\\x20\\t\\r\\n\\f]+$","g"),bd=/^[\x20\t\r\n\f]*,[\x20\t\r\n\f]*/,
cd=/^[\x20\t\r\n\f]*([>+~]|[\x20\t\r\n\f])[\x20\t\r\n\f]*/,vb=/[\x20\t\r\n\f]*[+~]/,hd=RegExp("=[\\x20\\t\\r\\n\\f]*([^\\]'\"]*)[\\x20\\t\\r\\n\\f]*\\]","g"),id=RegExp(Eb),jd=RegExp("^"+ic+"$"),db={ID:/^#((?:\\.|[\w-]|[^\x00-\xa0])+)/,CLASS:/^\.((?:\\.|[\w-]|[^\x00-\xa0])+)/,TAG:RegExp("^("+"(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+".replace("w","w*")+")"),ATTR:RegExp("^"+jc),PSEUDO:RegExp("^"+Eb),CHILD:RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\([\\x20\\t\\r\\n\\f]*(even|odd|(([+-]|)(\\d*)n|)[\\x20\\t\\r\\n\\f]*(?:([+-]|)[\\x20\\t\\r\\n\\f]*(\\d+)|))[\\x20\\t\\r\\n\\f]*\\)|)",
"i"),bool:RegExp("^(?:checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped)$","i"),needsContext:RegExp("^[\\x20\\t\\r\\n\\f]*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\([\\x20\\t\\r\\n\\f]*((?:-\\d)?\\d*)[\\x20\\t\\r\\n\\f]*\\)|)(?=[^-]|$)","i")},Fb=/^[^{]+\{\s*\[native \w/,Yc=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,kd=/^(?:input|select|textarea|button)$/i,ld=/^h\d$/i,Zc=/'|\\/g,ua=RegExp("\\\\([\\da-f]{1,6}[\\x20\\t\\r\\n\\f]?|([\\x20\\t\\r\\n\\f])|.)",
"ig"),va=function(a,b,c){a="0x"+b-65536;return a!==a||c?b:0>a?String.fromCharCode(a+65536):String.fromCharCode(55296|a>>10,56320|1023&a)};try{ta.apply(wa=hc.call(oa.childNodes),oa.childNodes),wa[oa.childNodes.length].nodeType}catch(Od){ta={apply:wa.length?function(a,b){gd.apply(a,hc.call(b))}:function(a,b){for(var c=a.length,d=0;a[c++]=b[d++];);a.length=c-1}}}ec=I.isXML=function(a){return(a=a&&(a.ownerDocument||a).documentElement)?"HTML"!==a.nodeName:!1};L=I.support={};Ca=I.setDocument=function(a){var b=
a?a.ownerDocument||a:oa,a=b.defaultView;return b!==Y&&9===b.nodeType&&b.documentElement?(Y=b,ka=b.documentElement,ia=!ec(b),a&&a.attachEvent&&a!==a.top&&a.attachEvent("onbeforeunload",function(){Ca()}),L.attributes=ga(function(a){return a.className="i",!a.getAttribute("className")}),L.getElementsByTagName=ga(function(a){return a.appendChild(b.createComment("")),!a.getElementsByTagName("*").length}),L.getElementsByClassName=ga(function(a){return a.innerHTML="<div class='a'></div><div class='a i'></div>",
a.firstChild.className="i",2===a.getElementsByClassName("i").length}),L.getById=ga(function(a){return ka.appendChild(a).id=S,!b.getElementsByName||!b.getElementsByName(S).length}),L.getById?(H.find.ID=function(a,b){if("undefined"!==typeof b.getElementById&&ia){var c=b.getElementById(a);return c&&c.parentNode?[c]:[]}},H.filter.ID=function(a){var b=a.replace(ua,va);return function(a){return a.getAttribute("id")===b}}):(delete H.find.ID,H.filter.ID=function(a){var b=a.replace(ua,va);return function(a){return(a=
"undefined"!==typeof a.getAttributeNode&&a.getAttributeNode("id"))&&a.value===b}}),H.find.TAG=L.getElementsByTagName?function(a,b){return"undefined"!==typeof b.getElementsByTagName?b.getElementsByTagName(a):void 0}:function(a,b){var c,d=[],e=0,f=b.getElementsByTagName(a);if("*"===a){for(;c=f[e++];)1===c.nodeType&&d.push(c);return d}return f},H.find.CLASS=L.getElementsByClassName&&function(a,b){return"undefined"!==typeof b.getElementsByClassName&&ia?b.getElementsByClassName(a):void 0},Ga=[],da=[],
(L.qsa=Fb.test(b.querySelectorAll))&&(ga(function(a){a.innerHTML="<select><option selected=''></option></select>";a.querySelectorAll("[selected]").length||da.push("\\[[\\x20\\t\\r\\n\\f]*(?:value|checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped)");a.querySelectorAll(":checked").length||da.push(":checked")}),ga(function(a){var c=b.createElement("input");c.setAttribute("type","hidden");a.appendChild(c).setAttribute("t","");a.querySelectorAll("[t^='']").length&&
da.push("[*^$]=[\\x20\\t\\r\\n\\f]*(?:''|\"\")");a.querySelectorAll(":enabled").length||da.push(":enabled",":disabled");a.querySelectorAll("*,:x");da.push(",.*:")})),(L.matchesSelector=Fb.test(ib=ka.webkitMatchesSelector||ka.mozMatchesSelector||ka.oMatchesSelector||ka.msMatchesSelector))&&ga(function(a){L.disconnectedMatch=ib.call(a,"div");ib.call(a,"[s!='']:x");Ga.push("!=",Eb)}),da=da.length&&RegExp(da.join("|")),Ga=Ga.length&&RegExp(Ga.join("|")),Ua=Fb.test(ka.contains)||ka.compareDocumentPosition?
function(a,b){var c=9===a.nodeType?a.documentElement:a,d=b&&b.parentNode;return a===d||!(!d||1!==d.nodeType||!(c.contains?c.contains(d):a.compareDocumentPosition&&16&a.compareDocumentPosition(d)))}:function(a,b){if(b)for(;b=b.parentNode;)if(b===a)return!0;return!1},Db=ka.compareDocumentPosition?function(a,c){if(a===c)return Na=!0,0;var d=c.compareDocumentPosition&&a.compareDocumentPosition&&a.compareDocumentPosition(c);return d?1&d||!L.sortDetached&&c.compareDocumentPosition(a)===d?a===b||Ua(oa,a)?
-1:c===b||Ua(oa,c)?1:Fa?Ea.call(Fa,a)-Ea.call(Fa,c):0:4&d?-1:1:a.compareDocumentPosition?-1:1}:function(a,c){var d,e=0;d=a.parentNode;var f=c.parentNode,h=[a],j=[c];if(a===c)return Na=!0,0;if(!d||!f)return a===b?-1:c===b?1:d?-1:f?1:Fa?Ea.call(Fa,a)-Ea.call(Fa,c):0;if(d===f)return bc(a,c);for(d=a;d=d.parentNode;)h.unshift(d);for(d=c;d=d.parentNode;)j.unshift(d);for(;h[e]===j[e];)e++;return e?bc(h[e],j[e]):h[e]===oa?-1:j[e]===oa?1:0},b):Y};I.matches=function(a,b){return I(a,null,null,b)};I.matchesSelector=
function(a,b){if((a.ownerDocument||a)!==Y&&Ca(a),b=b.replace(hd,"='$1']"),!(!L.matchesSelector||!ia||Ga&&Ga.test(b)||da&&da.test(b)))try{var c=ib.call(a,b);if(c||L.disconnectedMatch||a.document&&11!==a.document.nodeType)return c}catch(d){}return 0<I(b,Y,null,[a]).length};I.contains=function(a,b){return(a.ownerDocument||a)!==Y&&Ca(a),Ua(a,b)};I.attr=function(a,b){(a.ownerDocument||a)!==Y&&Ca(a);var c=H.attrHandle[b.toLowerCase()],c=c&&ed.call(H.attrHandle,b.toLowerCase())?c(a,b,!ia):void 0;return void 0===
c?L.attributes||!ia?a.getAttribute(b):(c=a.getAttributeNode(b))&&c.specified?c.value:null:c};I.error=function(a){throw Error("Syntax error, unrecognized expression: "+a);};I.uniqueSort=function(a){var b,c=[],d=0,e=0;if(Na=!L.detectDuplicates,Fa=!L.sortStable&&a.slice(0),a.sort(Db),Na){for(;b=a[e++];)b===a[e]&&(d=c.push(e));for(;d--;)a.splice(c[d],1)}return a};hb=I.getText=function(a){var b,c="",d=0;if(b=a.nodeType)if(1===b||9===b||11===b){if("string"==typeof a.textContent)return a.textContent;for(a=
a.firstChild;a;a=a.nextSibling)c+=hb(a)}else{if(3===b||4===b)return a.nodeValue}else for(;b=a[d];d++)c+=hb(b);return c};H=I.selectors={cacheLength:50,createPseudo:fa,match:db,attrHandle:{},find:{},relative:{">":{dir:"parentNode",first:!0}," ":{dir:"parentNode"},"+":{dir:"previousSibling",first:!0},"~":{dir:"previousSibling"}},preFilter:{ATTR:function(a){return a[1]=a[1].replace(ua,va),a[3]=(a[4]||a[5]||"").replace(ua,va),"~="===a[2]&&(a[3]=" "+a[3]+" "),a.slice(0,4)},CHILD:function(a){return a[1]=
a[1].toLowerCase(),"nth"===a[1].slice(0,3)?(a[3]||I.error(a[0]),a[4]=+(a[4]?a[5]+(a[6]||1):2*("even"===a[3]||"odd"===a[3])),a[5]=+(a[7]+a[8]||"odd"===a[3])):a[3]&&I.error(a[0]),a},PSEUDO:function(a){var b,c=!a[5]&&a[2];return db.CHILD.test(a[0])?null:(a[3]&&void 0!==a[4]?a[2]=a[4]:c&&id.test(c)&&(b=ab(c,!0))&&(b=c.indexOf(")",c.length-b)-c.length)&&(a[0]=a[0].slice(0,b),a[2]=c.slice(0,b)),a.slice(0,3))}},filter:{TAG:function(a){var b=a.replace(ua,va).toLowerCase();return"*"===a?function(){return!0}:
function(a){return a.nodeName&&a.nodeName.toLowerCase()===b}},CLASS:function(a){var b=fc[a+" "];return b||(b=RegExp("(^|[\\x20\\t\\r\\n\\f])"+a+"([\\x20\\t\\r\\n\\f]|$)"))&&fc(a,function(a){return b.test("string"==typeof a.className&&a.className||"undefined"!==typeof a.getAttribute&&a.getAttribute("class")||"")})},ATTR:function(a,b,c){return function(d){d=I.attr(d,a);return null==d?"!="===b:b?(d+="","="===b?d===c:"!="===b?d!==c:"^="===b?c&&0===d.indexOf(c):"*="===b?c&&-1<d.indexOf(c):"$="===b?c&&
d.slice(-c.length)===c:"~="===b?-1<(" "+d+" ").indexOf(c):"|="===b?d===c||d.slice(0,c.length+1)===c+"-":!1):!0}},CHILD:function(a,b,c,d,e){var f="nth"!==a.slice(0,3),h="last"!==a.slice(-4),j="of-type"===b;return 1===d&&0===e?function(a){return!!a.parentNode}:function(b,c,g){var n,p,m,k,P,c=f!==h?"nextSibling":"previousSibling",V=b.parentNode,q=j&&b.nodeName.toLowerCase(),g=!g&&!j;if(V){if(f){for(;c;){for(p=b;p=p[c];)if(j?p.nodeName.toLowerCase()===q:1===p.nodeType)return!1;P=c="only"===a&&!P&&"nextSibling"}return!0}if(P=
[h?V.firstChild:V.lastChild],h&&g){g=V[S]||(V[S]={});n=g[a]||[];k=n[0]===ja&&n[1];m=n[0]===ja&&n[2];for(p=k&&V.childNodes[k];p=++k&&p&&p[c]||(m=k=0)||P.pop();)if(1===p.nodeType&&++m&&p===b){g[a]=[ja,k,m];break}}else if(g&&(n=(b[S]||(b[S]={}))[a])&&n[0]===ja)m=n[1];else for(;(p=++k&&p&&p[c]||(m=k=0)||P.pop())&&(!(j?p.nodeName.toLowerCase()===q:1===p.nodeType)||!++m||!(g&&((p[S]||(p[S]={}))[a]=[ja,m]),p===b)););return m-=e,m===d||0===m%d&&0<=m/d}}},PSEUDO:function(a,b){var c,d=H.pseudos[a]||H.setFilters[a.toLowerCase()]||
I.error("unsupported pseudo: "+a);return d[S]?d(b):1<d.length?(c=[a,a,"",b],H.setFilters.hasOwnProperty(a.toLowerCase())?fa(function(a,c){for(var e,f=d(a,b),h=f.length;h--;)e=Ea.call(a,f[h]),a[e]=!(c[e]=f[h])}):function(a){return d(a,0,c)}):d}},pseudos:{not:fa(function(a){var b=[],c=[],d=wb(a.replace(cb,"$1"));return d[S]?fa(function(a,b,c,e){for(var f,c=d(a,null,e,[]),e=a.length;e--;)(f=c[e])&&(a[e]=!(b[e]=f))}):function(a,e,f){return b[0]=a,d(b,null,f,c),!c.pop()}}),has:fa(function(a){return function(b){return 0<
I(a,b).length}}),contains:fa(function(a){return function(b){return-1<(b.textContent||b.innerText||hb(b)).indexOf(a)}}),lang:fa(function(a){return jd.test(a||"")||I.error("unsupported lang: "+a),a=a.replace(ua,va).toLowerCase(),function(b){var c;do if(c=ia?b.lang:b.getAttribute("xml:lang")||b.getAttribute("lang"))return c=c.toLowerCase(),c===a||0===c.indexOf(a+"-");while((b=b.parentNode)&&1===b.nodeType);return!1}}),target:function(a){var b=ub.location&&ub.location.hash;return b&&b.slice(1)===a.id},
root:function(a){return a===ka},focus:function(a){return a===Y.activeElement&&(!Y.hasFocus||Y.hasFocus())&&!(!a.type&&!a.href&&!~a.tabIndex)},enabled:function(a){return!1===a.disabled},disabled:function(a){return!0===a.disabled},checked:function(a){var b=a.nodeName.toLowerCase();return"input"===b&&!!a.checked||"option"===b&&!!a.selected},selected:function(a){return a.parentNode&&a.parentNode.selectedIndex,!0===a.selected},empty:function(a){for(a=a.firstChild;a;a=a.nextSibling)if("@"<a.nodeName||3===
a.nodeType||4===a.nodeType)return!1;return!0},parent:function(a){return!H.pseudos.empty(a)},header:function(a){return ld.test(a.nodeName)},input:function(a){return kd.test(a.nodeName)},button:function(a){var b=a.nodeName.toLowerCase();return"input"===b&&"button"===a.type||"button"===b},text:function(a){var b;return"input"===a.nodeName.toLowerCase()&&"text"===a.type&&(null==(b=a.getAttribute("type"))||b.toLowerCase()===a.type)},first:Da(function(){return[0]}),last:Da(function(a,b){return[b-1]}),eq:Da(function(a,
b,c){return[0>c?c+b:c]}),even:Da(function(a,b){for(var c=0;b>c;c+=2)a.push(c);return a}),odd:Da(function(a,b){for(var c=1;b>c;c+=2)a.push(c);return a}),lt:Da(function(a,b,c){for(b=0>c?c+b:c;0<=--b;)a.push(b);return a}),gt:Da(function(a,b,c){for(c=0>c?c+b:c;b>++c;)a.push(c);return a})}};H.pseudos.nth=H.pseudos.eq;for(Ma in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})H.pseudos[Ma]=$c(Ma);for(Ma in{submit:!0,reset:!0})H.pseudos[Ma]=ad(Ma);cc.prototype=H.filters=H.pseudos;H.setFilters=new cc;wb=
I.compile=function(a,b){var c,d=[],e=[],f=gc[a+" "];if(!f){b||(b=ab(a));for(c=b.length;c--;)f=Cb(b[c]),f[S]?d.push(f):e.push(f);var h=0,j=0<d.length,g=0<e.length;c=function(a,b,c,f,n){var J,p,m=[],k=0,P="0",q=a&&[],V=null!=n,t=gb,x=a||g&&H.find.TAG("*",n&&b.parentNode||b),s=ja+=null==t?1:Math.random()||0.1;for(V&&(gb=b!==Y&&b,eb=h);null!=(n=x[P]);P++){if(g&&n){for(J=0;p=e[J++];)if(p(n,b,c)){f.push(n);break}V&&(ja=s,eb=++h)}j&&((n=!p&&n)&&k--,a&&q.push(n))}if(k+=P,j&&P!==k){for(J=0;p=d[J++];)p(q,m,
b,c);if(a){if(0<k)for(;P--;)q[P]||m[P]||(m[P]=fd.call(f));m=fb(m)}ta.apply(f,m);V&&!a&&0<m.length&&1<k+d.length&&I.uniqueSort(f)}return V&&(ja=s,gb=t),q};c=j?fa(c):c;f=gc(a,c)}return f};L.sortStable=S.split("").sort(Db).join("")===S;L.detectDuplicates=Na;Ca();L.sortDetached=ga(function(a){return 1&a.compareDocumentPosition(Y.createElement("div"))});ga(function(a){return a.innerHTML="<a href='#'></a>","#"===a.firstChild.getAttribute("href")})||yb("type|href|height|width",function(a,b,c){return c?void 0:
a.getAttribute(b,"type"===b.toLowerCase()?1:2)});L.attributes&&ga(function(a){return a.innerHTML="<input/>",a.firstChild.setAttribute("value",""),""===a.firstChild.getAttribute("value")})||yb("value",function(a,b,c){return c||"input"!==a.nodeName.toLowerCase()?void 0:a.defaultValue});ga(function(a){return null==a.getAttribute("disabled")})||yb("checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped",function(a,b,c){var d;return c?
void 0:(d=a.getAttributeNode(b))&&d.specified?d.value:!0===a[b]?b.toLowerCase():null});k.find=I;k.expr=I.selectors;k.expr[":"]=k.expr.pseudos;k.unique=I.uniqueSort;k.text=I.getText;k.isXMLDoc=I.isXML;k.contains=I.contains;var kc={};k.Callbacks=function(a){var c;if("string"==typeof a){if(!(c=kc[a])){c=a;var d=kc[c]={};c=(k.each(c.match(ma)||[],function(a,b){d[b]=!0}),d)}}else c=k.extend({},a);var a=c,e,f,h,j,g,n,p=[],m=!a.once&&[],q=function(b){f=a.memory&&b;h=!0;g=n||0;n=0;j=p.length;for(e=!0;p&&
j>g;g++)if(!1===p[g].apply(b[0],b[1])&&a.stopOnFalse){f=!1;break}e=!1;p&&(m?m.length&&q(m.shift()):f?p=[]:t.disable())},t={add:function(){if(p){var b=p.length;(function Lc(b){k.each(b,function(b,c){var d=k.type(c);"function"===d?a.unique&&t.has(c)||p.push(c):c&&c.length&&"string"!==d&&Lc(c)})})(arguments);e?j=p.length:f&&(n=b,q(f))}return this},remove:function(){return p&&k.each(arguments,function(a,b){for(var c;-1<(c=k.inArray(b,p,c));)p.splice(c,1),e&&(j>=c&&j--,g>=c&&g--)}),this},has:function(a){return a?
-1<k.inArray(a,p):!(!p||!p.length)},empty:function(){return p=[],j=0,this},disable:function(){return p=m=f=b,this},disabled:function(){return!p},lock:function(){return m=b,f||t.disable(),this},locked:function(){return!m},fireWith:function(a,b){return!p||h&&!m||(b=b||[],b=[a,b.slice?b.slice():b],e?m.push(b):q(b)),this},fire:function(){return t.fireWith(this,arguments),this},fired:function(){return!!h}};return t};k.extend({Deferred:function(a){var b=[["resolve","done",k.Callbacks("once memory"),"resolved"],
...
this,j?[a]:arguments)})});a=null}).promise()},promise:function(a){return null!=a?k.extend(a,d):d}},e={};return d.pipe=d.then,k.each(b,function(a,f){var h=f[2],j=f[3];d[f[1]]=h.add;j&&h.add(function(){c=j},b[1^a][2].disable,b[2][2].lock);e[f[0]]=function(){return e[f[0]+"With"](this===e?d:this,arguments),this};e[f[0]+"With"]=h.fireWith}),d.promise(e),a&&a.call(e,e),e},when:function(a){var b=0,c=Ba.call(arguments),d=c.length,e=1!==d||a&&k.isFunction(a.promise)?d:0,f=1===e?a:k.Deferred(),h=function(a,
b,c){return function(d){b[a]=this;c[a]=1<arguments.length?Ba.call(arguments):d;c===j?f.notifyWith(b,c):--e||f.resolveWith(b,c)}},j,g,n;if(1<d){j=Array(d);g=Array(d);for(n=Array(d);d>b;b++)c[b]&&k.isFunction(c[b].promise)?c[b].promise().done(h(b,n,c)).fail(f.reject).progress(h(b,g,j)):--e}return e||f.resolveWith(n,c),f.promise()}});var md=k,Gb,D={},Hb,pa,Z,jb,kb,lb,Ib,lc,Va,E=A.createElement("div");if(E.setAttribute("className","t"),E.innerHTML="  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>",
Hb=E.getElementsByTagName("*")||[],pa=E.getElementsByTagName("a")[0],!pa||!pa.style||!Hb.length)Gb=D;else{jb=A.createElement("select");lb=jb.appendChild(A.createElement("option"));Z=E.getElementsByTagName("input")[0];pa.style.cssText="top:1px;float:left;opacity:.5";D.getSetAttribute="t"!==E.className;D.leadingWhitespace=3===E.firstChild.nodeType;D.tbody=!E.getElementsByTagName("tbody").length;D.htmlSerialize=!!E.getElementsByTagName("link").length;D.style=/top/.test(pa.getAttribute("style"));D.hrefNormalized=
"/a"===pa.getAttribute("href");D.opacity=/^0.5/.test(pa.style.opacity);D.cssFloat=!!pa.style.cssFloat;D.checkOn=!!Z.value;D.optSelected=lb.selected;D.enctype=!!A.createElement("form").enctype;D.html5Clone="<:nav></:nav>"!==A.createElement("nav").cloneNode(!0).outerHTML;D.inlineBlockNeedsLayout=!1;D.shrinkWrapBlocks=!1;D.pixelPosition=!1;D.deleteExpando=!0;D.noCloneEvent=!0;D.reliableMarginRight=!0;D.boxSizingReliable=!0;Z.checked=!0;D.noCloneChecked=Z.cloneNode(!0).checked;jb.disabled=!0;D.optDisabled=
!lb.disabled;try{delete E.test}catch(Pd){D.deleteExpando=!1}Z=A.createElement("input");Z.setAttribute("value","");D.input=""===Z.getAttribute("value");Z.value="t";Z.setAttribute("type","radio");D.radioValue="t"===Z.value;Z.setAttribute("checked","t");Z.setAttribute("name","t");kb=A.createDocumentFragment();kb.appendChild(Z);D.appendChecked=Z.checked;D.checkClone=kb.cloneNode(!0).cloneNode(!0).lastChild.checked;E.attachEvent&&(E.attachEvent("onclick",function(){D.noCloneEvent=!1}),E.cloneNode(!0).click());
for(Va in{submit:!0,change:!0,focusin:!0})E.setAttribute(Ib="on"+Va,"t"),D[Va+"Bubbles"]=Ib in a||!1===E.attributes[Ib].expando;E.style.backgroundClip="content-box";E.cloneNode(!0).style.backgroundClip="";D.clearCloneStyle="content-box"===E.style.backgroundClip;for(Va in k(D))break;Gb=(D.ownLast="0"!==Va,k(function(){var b,c,d,e=A.getElementsByTagName("body")[0];e&&(b=A.createElement("div"),b.style.cssText="border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px",e.appendChild(b).appendChild(E),
E.innerHTML="<table><tr><td></td><td>t</td></tr></table>",d=E.getElementsByTagName("td"),d[0].style.cssText="padding:0;margin:0;border:0;display:none",lc=0===d[0].offsetHeight,d[0].style.display="",d[1].style.display="none",D.reliableHiddenOffsets=lc&&0===d[0].offsetHeight,E.innerHTML="",E.style.cssText="box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;padding:1px;border:1px;display:block;width:4px;margin-top:1%;position:absolute;top:1%;",k.swap(e,null!=e.style.zoom?
{zoom:1}:{},function(){D.boxSizing=4===E.offsetWidth}),a.getComputedStyle&&(D.pixelPosition="1%"!==(a.getComputedStyle(E,null)||{}).top,D.boxSizingReliable="4px"===(a.getComputedStyle(E,null)||{width:"4px"}).width,c=E.appendChild(A.createElement("div")),c.style.cssText=E.style.cssText="padding:0;margin:0;border:0;display:block;box-sizing:content-box;-moz-box-sizing:content-box;-webkit-box-sizing:content-box;",c.style.marginRight=c.style.width="0",E.style.width="1px",D.reliableMarginRight=!parseFloat((a.getComputedStyle(c,
null)||{}).marginRight)),typeof E.style.zoom!==F&&(E.innerHTML="",E.style.cssText="padding:0;margin:0;border:0;display:block;box-sizing:content-box;-moz-box-sizing:content-box;-webkit-box-sizing:content-box;width:1px;padding:1px;display:inline;zoom:1",D.inlineBlockNeedsLayout=3===E.offsetWidth,E.style.display="block",E.innerHTML="<div></div>",E.firstChild.style.width="5px",D.shrinkWrapBlocks=3!==E.offsetWidth,D.inlineBlockNeedsLayout&&(e.style.zoom=1)),e.removeChild(b),b=E=d=c=null)}),Hb=jb=kb=lb=
pa=Z=null,D)}md.support=Gb;var Gc=/(?:\{[\s\S]*\}|\[[\s\S]*\])$/,Fc=/([A-Z])/g;k.extend({cache:{},noData:{applet:!0,embed:!0,object:"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"},hasData:function(a){return a=a.nodeType?k.cache[a[k.expando]]:a[k.expando],!!a&&!g(a)},data:function(a,b,c){return d(a,b,c)},removeData:function(a,b){return e(a,b)},_data:function(a,b,c){return d(a,b,c,!0)},_removeData:function(a,b){return e(a,b,!0)},acceptData:function(a){if(a.nodeType&&1!==a.nodeType&&9!==a.nodeType)return!1;
...
f))&&(c=!0);return c||(a.selectedIndex=-1),f}}},attr:function(a,c,d){var e,f,h=a.nodeType;if(a&&3!==h&&8!==h&&2!==h)return typeof a.getAttribute===F?k.prop(a,c,d):(1===h&&k.isXMLDoc(a)||(c=c.toLowerCase(),e=k.attrHooks[c]||(k.expr.match.bool.test(c)?mc:Oa)),d===b?e&&"get"in e&&null!==(f=e.get(a,c))?f:(f=k.find.attr(a,c),null==f?b:f):null!==d?e&&"set"in e&&(f=e.set(a,d,c))!==b?f:(a.setAttribute(c,d+""),d):(k.removeAttr(a,c),b))},removeAttr:function(a,b){var c,d,e=0,f=b&&b.match(ma);if(f&&1===a.nodeType)for(;c=
f[e++];)d=k.propFix[c]||c,k.expr.match.bool.test(c)?mb&&Ha||!Kb.test(c)?a[d]=!1:a[k.camelCase("default-"+c)]=a[d]=!1:k.attr(a,c,""),a.removeAttribute(Ha?c:d)},attrHooks:{type:{set:function(a,b){if(!k.support.radioValue&&"radio"===b&&k.nodeName(a,"input")){var c=a.value;return a.setAttribute("type",b),c&&(a.value=c),b}}}},propFix:{"for":"htmlFor","class":"className"},prop:function(a,c,d){var e,f,h,j=a.nodeType;if(a&&3!==j&&8!==j&&2!==j)return h=1!==j||!k.isXMLDoc(a),h&&(c=k.propFix[c]||c,f=k.propHooks[c]),
d!==b?f&&"set"in f&&(e=f.set(a,d,c))!==b?e:a[c]=d:f&&"get"in f&&null!==(e=f.get(a,c))?e:a[c]},propHooks:{tabIndex:{get:function(a){var b=k.find.attr(a,"tabindex");return b?parseInt(b,10):od.test(a.nodeName)||pd.test(a.nodeName)&&a.href?0:-1}}}});mc={set:function(a,b,c){return!1===b?k.removeAttr(a,c):mb&&Ha||!Kb.test(c)?a.setAttribute(!Ha&&k.propFix[c]||c,c):a[k.camelCase("default-"+c)]=a[c]=!0,c}};k.each(k.expr.match.bool.source.match(/\w+/g),function(a,c){var d=k.expr.attrHandle[c]||k.find.attr;
k.expr.attrHandle[c]=mb&&Ha||!Kb.test(c)?function(a,c,e){var f=k.expr.attrHandle[c],a=e?b:(k.expr.attrHandle[c]=b)!=d(a,c,e)?c.toLowerCase():null;return k.expr.attrHandle[c]=f,a}:function(a,c,d){return d?b:a[k.camelCase("default-"+c)]?c.toLowerCase():null}});mb&&Ha||(k.attrHooks.value={set:function(a,c,d){return k.nodeName(a,"input")?(a.defaultValue=c,b):Oa&&Oa.set(a,c,d)}});Ha||(Oa={set:function(a,c,d){var e=a.getAttributeNode(d);return e||a.setAttributeNode(e=a.ownerDocument.createAttribute(d)),
e.value=c+="","value"===d||c===a.getAttribute(d)?c:b}},k.expr.attrHandle.id=k.expr.attrHandle.name=k.expr.attrHandle.coords=function(a,c,d){var e;return d?b:(e=a.getAttributeNode(c))&&""!==e.value?e.value:null},k.valHooks.button={get:function(a,c){var d=a.getAttributeNode(c);return d&&d.specified?d.value:b},set:Oa.set},k.attrHooks.contenteditable={set:function(a,b,c){Oa.set(a,""===b?!1:b,c)}},k.each(["width","height"],function(a,c){k.attrHooks[c]={set:function(a,d){return""===d?(a.setAttribute(c,
...
function(){k.propFix[this.toLowerCase()]=this});k.support.enctype||(k.propFix.enctype="encoding");k.each(["radio","checkbox"],function(){k.valHooks[this]={set:function(a,c){return k.isArray(c)?a.checked=0<=k.inArray(k(a).val(),c):b}};k.support.checkOn||(k.valHooks[this].get=function(a){return null===a.getAttribute("value")?"on":a.value})});var Lb=/^(?:input|select|textarea)$/i,qd=/^key/,rd=/^(?:mouse|contextmenu)|click/,nc=/^(?:focusinfocus|focusoutblur)$/,oc=/^([^.]*)(?:\.(.+)|)$/;k.event={global:{},
add:function(a,c,d,e,f){var h,j,g,n,p,m,q,t,x,s;if(g=k._data(a)){d.handler&&(n=d,d=n.handler,f=n.selector);d.guid||(d.guid=k.guid++);(j=g.events)||(j=g.events={});(m=g.handle)||(m=g.handle=function(a){return typeof k===F||a&&k.event.triggered===a.type?b:k.event.dispatch.apply(m.elem,arguments)},m.elem=a);c=(c||"").match(ma)||[""];for(g=c.length;g--;)h=oc.exec(c[g])||[],x=s=h[1],h=(h[2]||"").split(".").sort(),x&&(p=k.event.special[x]||{},x=(f?p.delegateType:p.bindType)||x,p=k.event.special[x]||{},
q=k.extend({type:x,origType:s,data:e,handler:d,guid:d.guid,selector:f,needsContext:f&&k.expr.match.needsContext.test(f),namespace:h.join(".")},n),(t=j[x])||(t=j[x]=[],t.delegateCount=0,p.setup&&!1!==p.setup.call(a,e,h,m)||(a.addEventListener?a.addEventListener(x,m,!1):a.attachEvent&&a.attachEvent("on"+x,m))),p.add&&(p.add.call(a,q),q.handler.guid||(q.handler.guid=d.guid)),f?t.splice(t.delegateCount++,0,q):t.push(q),k.event.global[x]=!0);a=null}},remove:function(a,b,c,d,e){var f,h,j,g,n,p,m,q,t,x,
s,r=k.hasData(a)&&k._data(a);if(r&&(p=r.events)){b=(b||"").match(ma)||[""];for(n=b.length;n--;)if(j=oc.exec(b[n])||[],t=s=j[1],x=(j[2]||"").split(".").sort(),t){m=k.event.special[t]||{};t=(d?m.delegateType:m.bindType)||t;q=p[t]||[];j=j[2]&&RegExp("(^|\\.)"+x.join("\\.(?:.*\\.|)")+"(\\.|$)");for(g=f=q.length;f--;)h=q[f],!e&&s!==h.origType||c&&c.guid!==h.guid||j&&!j.test(h.namespace)||d&&d!==h.selector&&("**"!==d||!h.selector)||(q.splice(f,1),h.selector&&q.delegateCount--,m.remove&&m.remove.call(a,
h));g&&!q.length&&(m.teardown&&!1!==m.teardown.call(a,x,r.handle)||k.removeEvent(a,t,r.handle),delete p[t])}else for(t in p)k.event.remove(a,t+b[n],c,d,!0);k.isEmptyObject(p)&&(delete r.handle,k._removeData(a,"events"))}},trigger:function(c,d,e,f){var h,j,g,n,p,m,q=[e||A],t=La.call(c,"type")?c.type:c;m=La.call(c,"namespace")?c.namespace.split("."):[];if(g=h=e=e||A,3!==e.nodeType&&8!==e.nodeType&&!nc.test(t+k.event.triggered)&&(0<=t.indexOf(".")&&(m=t.split("."),t=m.shift(),m.sort()),j=0>t.indexOf(":")&&
"on"+t,c=c[k.expando]?c:new k.Event(t,"object"==typeof c&&c),c.isTrigger=f?2:3,c.namespace=m.join("."),c.namespace_re=c.namespace?RegExp("(^|\\.)"+m.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,c.result=b,c.target||(c.target=e),d=null==d?[c]:k.makeArray(d,[c]),p=k.event.special[t]||{},f||!p.trigger||!1!==p.trigger.apply(e,d))){if(!f&&!p.noBubble&&!k.isWindow(e)){n=p.delegateType||t;for(nc.test(n+t)||(g=g.parentNode);g;g=g.parentNode)q.push(g),h=g;h===(e.ownerDocument||A)&&q.push(h.defaultView||h.parentWindow||
a)}for(m=0;(g=q[m++])&&!c.isPropagationStopped();)c.type=1<m?n:p.bindType||t,(h=(k._data(g,"events")||{})[c.type]&&k._data(g,"handle"))&&h.apply(g,d),(h=j&&g[j])&&k.acceptData(g)&&h.apply&&!1===h.apply(g,d)&&c.preventDefault();if(c.type=t,!f&&!c.isDefaultPrevented()&&(!p._default||!1===p._default.apply(q.pop(),d))&&k.acceptData(e)&&j&&e[t]&&!k.isWindow(e)){(h=e[j])&&(e[j]=null);k.event.triggered=t;try{e[t]()}catch(x){}k.event.triggered=b;h&&(e[j]=h)}return c.result}},dispatch:function(a){var a=k.event.fix(a),
c,d,e,f,h,j=[],g=Ba.call(arguments);c=(k._data(this,"events")||{})[a.type]||[];var n=k.event.special[a.type]||{};if(g[0]=a,a.delegateTarget=this,!n.preDispatch||!1!==n.preDispatch.call(this,a)){j=k.event.handlers.call(this,a,c);for(c=0;(f=j[c++])&&!a.isPropagationStopped();){a.currentTarget=f.elem;for(h=0;(e=f.handlers[h++])&&!a.isImmediatePropagationStopped();)(!a.namespace_re||a.namespace_re.test(e.namespace))&&(a.handleObj=e,a.data=e.data,d=((k.event.special[e.origType]||{}).handle||e.handler).apply(f.elem,
...
c,!1)}:function(a,b,c){b="on"+b;a.detachEvent&&(typeof a[b]===F&&(a[b]=null),a.detachEvent(b,c))};k.Event=function(a,c){return this instanceof k.Event?(a&&a.type?(this.originalEvent=a,this.type=a.type,this.isDefaultPrevented=a.defaultPrevented||!1===a.returnValue||a.getPreventDefault&&a.getPreventDefault()?h:j):this.type=a,c&&k.extend(this,c),this.timeStamp=a&&a.timeStamp||k.now(),this[k.expando]=!0,b):new k.Event(a,c)};k.Event.prototype={isDefaultPrevented:j,isPropagationStopped:j,isImmediatePropagationStopped:j,
...
b)},postDispatch:function(a){a._submit_bubble&&(delete a._submit_bubble,this.parentNode&&!a.isTrigger&&k.event.simulate("submit",this.parentNode,a,!0))},teardown:function(){return k.nodeName(this,"form")?!1:(k.event.remove(this,"._submit"),b)}});k.support.changeBubbles||(k.event.special.change={setup:function(){return Lb.test(this.nodeName)?(("checkbox"===this.type||"radio"===this.type)&&(k.event.add(this,"propertychange._change",function(a){"checked"===a.originalEvent.propertyName&&(this._just_changed=
!0)}),k.event.add(this,"click._change",function(a){this._just_changed&&!a.isTrigger&&(this._just_changed=!1);k.event.simulate("change",this,a,!0)})),!1):(k.event.add(this,"beforeactivate._change",function(a){a=a.target;Lb.test(a.nodeName)&&!k._data(a,"changeBubbles")&&(k.event.add(a,"change._change",function(a){!this.parentNode||a.isSimulated||a.isTrigger||k.event.simulate("change",this.parentNode,a,!0)}),k._data(a,"changeBubbles",!0))}),b)},handle:function(a){var c=a.target;return this!==c||a.isSimulated||
a.isTrigger||"radio"!==c.type&&"checkbox"!==c.type?a.handleObj.handler.apply(this,arguments):b},teardown:function(){return k.event.remove(this,"._change"),!Lb.test(this.nodeName)}});k.support.focusinBubbles||k.each({focus:"focusin",blur:"focusout"},function(a,b){var c=0,d=function(a){k.event.simulate(b,a.target,k.event.fix(a),!0)};k.event.special[b]={setup:function(){0===c++&&A.addEventListener(a,d,!0)},teardown:function(){0===--c&&A.removeEventListener(a,d,!0)}}});k.fn.extend({on:function(a,c,d,
...
contents:function(a){return k.nodeName(a,"iframe")?a.contentDocument||a.contentWindow.document:k.merge([],a.childNodes)}},function(a,b){k.fn[a]=function(c,d){var e=k.map(this,b,c);return"Until"!==a.slice(-5)&&(d=c),d&&"string"==typeof d&&(e=k.filter(d,e)),1<this.length&&(td[a]||(e=k.unique(e)),sd.test(a)&&(e=e.reverse())),this.pushStack(e)}});k.extend({filter:function(a,b,c){var d=b[0];return c&&(a=":not("+a+")"),1===b.length&&1===d.nodeType?k.find.matchesSelector(d,a)?[d]:[]:k.find.matches(a,k.grep(b,
function(a){return 1===a.nodeType}))},dir:function(a,c,d){for(var e=[],a=a[c];a&&9!==a.nodeType&&(d===b||1!==a.nodeType||!k(a).is(d));)1===a.nodeType&&e.push(a),a=a[c];return e},sibling:function(a,b){for(var c=[];a;a=a.nextSibling)1===a.nodeType&&a!==b&&c.push(a);return c}});var Tb="abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",ud=/ jQuery\d+="(?:null|\d+)"/g,qc=RegExp("<(?:"+Tb+")[\\s/>]",
"i"),Mb=/^\s+/,rc=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,sc=/<([\w:]+)/,tc=/<tbody/i,vd=/<|&#?\w+;/,wd=/<(?:script|style|link)/i,pb=/^(?:checkbox|radio)$/i,xd=/checked\s*(?:[^=]|=\s*.checked.)/i,uc=/^$|\/(?:java|ecma)script/i,Ic=/^true\/(.*)/,yd=/^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g,ea={option:[1,"<select multiple='multiple'>","</select>"],legend:[1,"<fieldset>","</fieldset>"],area:[1,"<map>","</map>"],param:[1,"<object>","</object>"],thead:[1,"<table>","</table>"],
tr:[2,"<table><tbody>","</tbody></table>"],col:[2,"<table><tbody></tbody><colgroup>","</colgroup></table>"],td:[3,"<table><tbody><tr>","</tr></tbody></table>"],_default:k.support.htmlSerialize?[0,"",""]:[1,"X<div>","</div>"]},Nb=m(A).appendChild(A.createElement("div"));ea.optgroup=ea.option;ea.tbody=ea.tfoot=ea.colgroup=ea.caption=ea.thead;ea.th=ea.td;k.fn.extend({text:function(a){return k.access(this,function(a){return a===b?k.text(this):this.empty().append((this[0]&&this[0].ownerDocument||A).createTextNode(a))},
...
clone:function(a,b){return a=null==a?!1:a,b=null==b?a:b,this.map(function(){return k.clone(this,a,b)})},html:function(a){return k.access(this,function(a){var c=this[0]||{},d=0,e=this.length;if(a===b)return 1===c.nodeType?c.innerHTML.replace(ud,""):b;if(!("string"!=typeof a||wd.test(a)||!k.support.htmlSerialize&&qc.test(a)||!k.support.leadingWhitespace&&Mb.test(a)||ea[(sc.exec(a)||["",""])[1].toLowerCase()])){a=a.replace(rc,"<$1></$2>");try{for(;e>d;d++)c=this[d]||{},1===c.nodeType&&(k.cleanData(w(c,
!1)),c.innerHTML=a);c=0}catch(f){}}c&&this.empty().append(a)},null,a,arguments.length)},replaceWith:function(){var a=k.map(this,function(a){return[a.nextSibling,a.parentNode]}),b=0;return this.domManip(arguments,function(c){var d=a[b++],e=a[b++];e&&(d&&d.parentNode!==e&&(d=this.nextSibling),k(this).remove(),e.insertBefore(c,d))},!0),b?this:this.remove()},detach:function(a){return this.remove(a,!0)},domManip:function(a,b,c){var a=Xb.apply([],a),d,e,f,h,j=0,g=this.length,n=this,p=g-1,m=a[0],q=k.isFunction(m);
if(q||!(1>=g||"string"!=typeof m||k.support.checkClone)&&xd.test(m))return this.each(function(d){var e=n.eq(d);q&&(a[0]=m.call(this,d,e.html()));e.domManip(a,b,c)});if(g&&(h=k.buildFragment(a,this[0].ownerDocument,!1,!c&&this),d=h.firstChild,1===h.childNodes.length&&(h=d),d)){f=k.map(w(h,"script"),r);for(e=f.length;g>j;j++)d=h,j!==p&&(d=k.clone(d,!0,!0),e&&k.merge(f,w(d,"script"))),b.call(this[j],d,j);if(e){h=f[f.length-1].ownerDocument;k.map(f,u);for(j=0;e>j;j++)d=f[j],uc.test(d.type||"")&&!k._data(d,
"globalEval")&&k.contains(h,d)&&(d.src?k._evalUrl(d.src):k.globalEval((d.text||d.textContent||d.innerHTML||"").replace(yd,"")))}h=d=null}return this}});k.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(a,b){k.fn[a]=function(a){for(var c=0,d=[],e=k(a),f=e.length-1;f>=c;c++)a=c===f?this:this.clone(!0),k(e[c])[b](a),rb.apply(d,a.get());return this.pushStack(d)}});k.extend({clone:function(a,b,c){var d,e,f,h,j,g=k.contains(a.ownerDocument,
a);if(k.support.html5Clone||k.isXMLDoc(a)||!qc.test("<"+a.nodeName+">")?f=a.cloneNode(!0):(Nb.innerHTML=a.outerHTML,Nb.removeChild(f=Nb.firstChild)),!(k.support.noCloneEvent&&k.support.noCloneChecked||1!==a.nodeType&&11!==a.nodeType||k.isXMLDoc(a))){d=w(f);j=w(a);for(h=0;null!=(e=j[h]);++h)if(d[h]){var n=d[h],p=void 0,m=void 0,q=void 0;if(1===n.nodeType){if(p=n.nodeName.toLowerCase(),!k.support.noCloneEvent&&n[k.expando]){q=k._data(n);for(m in q.events)k.removeEvent(n,m,q.handle);n.removeAttribute(k.expando)}"script"===
p&&n.text!==e.text?(r(n).text=e.text,u(n)):"object"===p?(n.parentNode&&(n.outerHTML=e.outerHTML),k.support.html5Clone&&e.innerHTML&&!k.trim(n.innerHTML)&&(n.innerHTML=e.innerHTML)):"input"===p&&pb.test(e.type)?(n.defaultChecked=n.checked=e.checked,n.value!==e.value&&(n.value=e.value)):"option"===p?n.defaultSelected=n.selected=e.defaultSelected:("input"===p||"textarea"===p)&&(n.defaultValue=e.defaultValue)}}}if(b)if(c){j=j||w(a);d=d||w(f);for(h=0;null!=(e=j[h]);h++)t(e,d[h])}else t(a,f);return d=w(f,
"script"),0<d.length&&v(d,!g&&w(a,"script")),f},buildFragment:function(a,b,c,d){for(var e,f,h,j,g,n,p,q=a.length,t=m(b),x=[],s=0;q>s;s++)if(f=a[s],f||0===f)if("object"===k.type(f))k.merge(x,f.nodeType?[f]:f);else if(vd.test(f)){j=j||t.appendChild(b.createElement("div"));g=(sc.exec(f)||["",""])[1].toLowerCase();p=ea[g]||ea._default;j.innerHTML=p[1]+f.replace(rc,"<$1></$2>")+p[2];for(e=p[0];e--;)j=j.lastChild;if(!k.support.leadingWhitespace&&Mb.test(f)&&x.push(b.createTextNode(Mb.exec(f)[0])),!k.support.tbody)for(e=
(f="table"!==g||tc.test(f)?"<table>"!==p[1]||tc.test(f)?0:j:j.firstChild)&&f.childNodes.length;e--;)k.nodeName(n=f.childNodes[e],"tbody")&&!n.childNodes.length&&f.removeChild(n);k.merge(x,j.childNodes);for(j.textContent="";j.firstChild;)j.removeChild(j.firstChild);j=t.lastChild}else x.push(b.createTextNode(f));j&&t.removeChild(j);k.support.appendChecked||k.grep(w(x,"input"),y);for(s=0;f=x[s++];)if((!d||-1===k.inArray(f,d))&&(h=k.contains(f.ownerDocument,f),j=w(t.appendChild(f),"script"),h&&v(j),c))for(e=
0;f=j[e++];)uc.test(f.type||"")&&c.push(f);return t},cleanData:function(a,b){for(var c,d,e,f,h=0,j=k.expando,g=k.cache,n=k.support.deleteExpando,p=k.event.special;null!=(c=a[h]);h++)if((b||k.acceptData(c))&&(e=c[j],f=e&&g[e])){if(f.events)for(d in f.events)p[d]?k.event.remove(c,d):k.removeEvent(c,d,f.handle);g[e]&&(delete g[e],n?delete c[j]:typeof c.removeAttribute!==F?c.removeAttribute(j):c[j]=null,Ja.push(e))}},_evalUrl:function(a){return k.ajax({url:a,type:"GET",dataType:"script",async:!1,global:!1,
...
delegate:function(a,b,c,d){return this.on(b,a,c,d)},undelegate:function(a,b,c){return 1===arguments.length?this.off(a,"**"):this.off(b,a||"**",c)}});var Ia,xa,Pb=k.now(),Qb=/\?/,Hd=/#.*$/,yc=/([?&])_=[^&]*/,Id=/^(.*?):[ \t]*([^\r\n]*)\r?$/gm,Jd=/^(?:GET|HEAD)$/,Kd=/^\/\//,zc=/^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/,Ac=k.fn.load,Bc={},qb={},Cc="*/".concat("*");try{xa=ca.href}catch(Qd){xa=A.createElement("a"),xa.href="",xa=xa.href}Ia=zc.exec(xa.toLowerCase())||[];k.fn.load=function(a,c,d){if("string"!=
typeof a&&Ac)return Ac.apply(this,arguments);var e,f,h,j=this,g=a.indexOf(" ");return 0<=g&&(e=a.slice(g,a.length),a=a.slice(0,g)),k.isFunction(c)?(d=c,c=b):c&&"object"==typeof c&&(h="POST"),0<j.length&&k.ajax({url:a,type:h,dataType:"html",data:c}).done(function(a){f=arguments;j.html(e?k("<div>").append(k.parseHTML(a)).find(e):a)}).complete(d&&function(a,b){j.each(d,f||[a.responseText,b,a])}),this};k.each("ajaxStart ajaxStop ajaxComplete ajaxError ajaxSuccess ajaxSend".split(" "),function(a,b){k.fn[b]=
function(a){return this.on(b,a)}});k.extend({active:0,lastModified:{},etag:{},ajaxSettings:{url:xa,type:"GET",isLocal:/^(?:about|app|app-storage|.+-extension|file|res|widget):$/.test(Ia[1]),global:!0,processData:!0,async:!0,contentType:"application/x-www-form-urlencoded; charset=UTF-8",accepts:{"*":Cc,text:"text/plain",html:"text/html",xml:"application/xml, text/xml",json:"application/json, text/javascript"},contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText",
json:"responseJSON"},converters:{"* text":String,"text html":!0,"text json":k.parseJSON,"text xml":k.parseXML},flatOptions:{url:!0,context:!0}},ajaxSetup:function(a,b){return b?ba(ba(a,k.ajaxSettings),b):ba(k.ajaxSettings,a)},ajaxPrefilter:ha(Bc),ajaxTransport:ha(qb),ajax:function(a,c){function d(a,c,e,f){var m,w,J,O,u=c;if(2!==B){B=2;g&&clearTimeout(g);p=b;j=f||"";z.readyState=0<a?4:0;f=200<=a&&300>a||304===a;if(e){J=q;for(var P=z,y,C,U,v,V=J.contents,la=J.dataTypes;"*"===la[0];)la.shift(),C===b&&
(C=J.mimeType||P.getResponseHeader("Content-Type"));if(C)for(v in V)if(V[v]&&V[v].test(C)){la.unshift(v);break}if(la[0]in e)U=la[0];else{for(v in e){if(!la[0]||J.converters[v+" "+la[0]]){U=v;break}y||(y=v)}U=U||y}J=U?(U!==la[0]&&la.unshift(U),e[U]):b}var aa;a:{e=q;y=J;C=z;U=f;var W,Q,X;J={};P=e.dataTypes.slice();if(P[1])for(W in e.converters)J[W.toLowerCase()]=e.converters[W];for(v=P.shift();v;)if(e.responseFields[v]&&(C[e.responseFields[v]]=y),!X&&U&&e.dataFilter&&(y=e.dataFilter(y,e.dataType)),
X=v,v=P.shift())if("*"===v)v=X;else if("*"!==X&&X!==v){if(W=J[X+" "+v]||J["* "+v],!W)for(aa in J)if(Q=aa.split(" "),Q[1]===v&&(W=J[X+" "+Q[0]]||J["* "+Q[0]])){!0===W?W=J[aa]:!0!==J[aa]&&(v=Q[0],P.unshift(Q[1]));break}if(!0!==W)if(W&&e["throws"])y=W(y);else try{y=W(y)}catch(ha){aa={state:"parsererror",error:W?ha:"No conversion from "+X+" to "+v};break a}}aa={state:"success",data:y}}J=aa;f?(q.ifModified&&(O=z.getResponseHeader("Last-Modified"),O&&(k.lastModified[h]=O),O=z.getResponseHeader("etag"),
O&&(k.etag[h]=O)),204===a||"HEAD"===q.type?u="nocontent":304===a?u="notmodified":(u=J.state,m=J.data,w=J.error,f=!w)):(w=u,(a||!u)&&(u="error",0>a&&(a=0)));z.status=a;z.statusText=(c||u)+"";f?s.resolveWith(t,[m,u,z]):s.rejectWith(t,[z,u,w]);z.statusCode(N);N=b;n&&x.trigger(f?"ajaxSuccess":"ajaxError",[z,q,f?m:w]);r.fireWith(t,[z,u]);n&&(x.trigger("ajaxComplete",[z,q]),--k.active||k.event.trigger("ajaxStop"))}}"object"==typeof a&&(c=a,a=b);var c=c||{},e,f,h,j,g,n,p,m,q=k.ajaxSetup({},c),t=q.context||
q,x=q.context&&(t.nodeType||t.jquery)?k(t):k.event,s=k.Deferred(),r=k.Callbacks("once memory"),N=q.statusCode||{},w={},O={},B=0,u="canceled",z={readyState:0,getResponseHeader:function(a){var b;if(2===B){if(!m)for(m={};b=Id.exec(j);)m[b[1].toLowerCase()]=b[2];b=m[a.toLowerCase()]}return null==b?null:b},getAllResponseHeaders:function(){return 2===B?j:null},setRequestHeader:function(a,b){var c=a.toLowerCase();return B||(a=O[c]=O[c]||a,w[a]=b),this},overrideMimeType:function(a){return B||(q.mimeType=
a),this},statusCode:function(a){var b;if(a)if(2>B)for(b in a)N[b]=[N[b],a[b]];else z.always(a[z.status]);return this},abort:function(a){a=a||u;return p&&p.abort(a),d(0,a),this}};if(s.promise(z).complete=r.add,z.success=z.done,z.error=z.fail,q.url=((a||q.url||xa)+"").replace(Hd,"").replace(Kd,Ia[1]+"//"),q.type=c.method||c.type||q.method||q.type,q.dataTypes=k.trim(q.dataType||"*").toLowerCase().match(ma)||[""],null==q.crossDomain&&(e=zc.exec(q.url.toLowerCase()),q.crossDomain=!(!e||e[1]===Ia[1]&&e[2]===
Ia[2]&&(e[3]||("http:"===e[1]?"80":"443"))===(Ia[3]||("http:"===Ia[1]?"80":"443")))),q.data&&q.processData&&"string"!=typeof q.data&&(q.data=k.param(q.data,q.traditional)),Q(Bc,q,c,z),2===B)return z;(n=q.global)&&0===k.active++&&k.event.trigger("ajaxStart");q.type=q.type.toUpperCase();q.hasContent=!Jd.test(q.type);h=q.url;q.hasContent||(q.data&&(h=q.url+=(Qb.test(h)?"&":"?")+q.data,delete q.data),!1===q.cache&&(q.url=yc.test(h)?h.replace(yc,"$1_="+Pb++):h+(Qb.test(h)?"&":"?")+"_="+Pb++));q.ifModified&&
(k.lastModified[h]&&z.setRequestHeader("If-Modified-Since",k.lastModified[h]),k.etag[h]&&z.setRequestHeader("If-None-Match",k.etag[h]));(q.data&&q.hasContent&&!1!==q.contentType||c.contentType)&&z.setRequestHeader("Content-Type",q.contentType);z.setRequestHeader("Accept",q.dataTypes[0]&&q.accepts[q.dataTypes[0]]?q.accepts[q.dataTypes[0]]+("*"!==q.dataTypes[0]?", "+Cc+"; q=0.01":""):q.accepts["*"]);for(f in q.headers)z.setRequestHeader(f,q.headers[f]);if(q.beforeSend&&(!1===q.beforeSend.call(t,z,q)||
2===B))return z.abort();u="abort";for(f in{success:1,error:1,complete:1})z[f](q[f]);if(p=Q(qb,q,c,z)){z.readyState=1;n&&x.trigger("ajaxSend",[z,q]);q.async&&0<q.timeout&&(g=setTimeout(function(){z.abort("timeout")},q.timeout));try{B=1,p.send(w,d)}catch(y){if(!(2>B))throw y;d(-1,y)}}else d(-1,"No Transport");return z},getJSON:function(a,b,c){return k.get(a,b,c,"json")},getScript:function(a,c){return k.get(a,b,c,"script")}});k.each(["get","post"],function(a,c){k[c]=function(a,d,e,f){return k.isFunction(d)&&
(f=f||e,e=d,d=b),k.ajax({url:a,type:c,dataType:f,data:d,success:e})}});k.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},contents:{script:/(?:java|ecma)script/},converters:{"text script":function(a){return k.globalEval(a),a}}});k.ajaxPrefilter("script",function(a){a.cache===b&&(a.cache=!1);a.crossDomain&&(a.type="GET",a.global=!1)});k.ajaxTransport("script",function(a){if(a.crossDomain){var c,d=A.head||k("head")[0]||A.documentElement;
return{send:function(b,e){c=A.createElement("script");c.async=!0;a.scriptCharset&&(c.charset=a.scriptCharset);c.src=a.url;c.onload=c.onreadystatechange=function(a,b){(b||!c.readyState||/loaded|complete/.test(c.readyState))&&(c.onload=c.onreadystatechange=null,c.parentNode&&c.parentNode.removeChild(c),c=null,b||e(200,"success"))};d.insertBefore(c,d.firstChild)},abort:function(){c&&c.onload(b,!0)}}}});var Dc=[],Rb=/(=)\?(?=&|$)|\?\?/;k.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var a=Dc.pop()||
k.expando+"_"+Pb++;return this[a]=!0,a}});k.ajaxPrefilter("json jsonp",function(c,d,e){var f,h,j,g=!1!==c.jsonp&&(Rb.test(c.url)?"url":"string"==typeof c.data&&!(c.contentType||"").indexOf("application/x-www-form-urlencoded")&&Rb.test(c.data)&&"data");return g||"jsonp"===c.dataTypes[0]?(f=c.jsonpCallback=k.isFunction(c.jsonpCallback)?c.jsonpCallback():c.jsonpCallback,g?c[g]=c[g].replace(Rb,"$1"+f):!1!==c.jsonp&&(c.url+=(Qb.test(c.url)?"&":"?")+c.jsonp+"="+f),c.converters["script json"]=function(){return j||
k.error(f+" was not called"),j[0]},c.dataTypes[0]="json",h=a[f],a[f]=function(){j=arguments},e.always(function(){a[f]=h;c[f]&&(c.jsonpCallback=d.jsonpCallback,Dc.push(f));j&&k.isFunction(h)&&h(j[0]);j=h=b}),"script"):b});var Pa,Wa,Ld=0,Sb=a.ActiveXObject&&function(){for(var a in Pa)Pa[a](b,!0)};k.ajaxSettings.xhr=a.ActiveXObject?function(){var b;if(!(b=!this.isLocal&&X()))a:{try{b=new a.ActiveXObject("Microsoft.XMLHTTP");break a}catch(c){}b=void 0}return b}:X;Wa=k.ajaxSettings.xhr();k.support.cors=
...
c.data||null);d=function(a,e){var j,n,p,m;try{if(d&&(e||4===g.readyState))if(d=b,h&&(g.onreadystatechange=k.noop,Sb&&delete Pa[h]),e)4!==g.readyState&&g.abort();else{m={};j=g.status;n=g.getAllResponseHeaders();"string"==typeof g.responseText&&(m.text=g.responseText);try{p=g.statusText}catch(q){p=""}j||!c.isLocal||c.crossDomain?1223===j&&(j=204):j=m.text?200:404}}catch(t){e||f(-1,t)}m&&f(j,p,m,n)};c.async?4===g.readyState?setTimeout(d):(h=++Ld,Sb&&(Pa||(Pa={},k(a).unload(Sb)),Pa[h]=d),g.onreadystatechange=
d):d()},abort:function(){d&&d(b,!0)}}}});var Ka,nb,Md=/^(?:toggle|show|hide)$/,Ec=RegExp("^(?:([+-])=|)("+$a+")([a-z%]*)$","i"),Nd=/queueHooks$/,Ya=[function(a,b,c){var d,e,f,h,j,g=this,n={},p=a.style,m=a.nodeType&&C(a),q=k._data(a,"fxshow");c.queue||(h=k._queueHooks(a,"fx"),null==h.unqueued&&(h.unqueued=0,j=h.empty.fire,h.empty.fire=function(){h.unqueued||j()}),h.unqueued++,g.always(function(){g.always(function(){h.unqueued--;k.queue(a,"fx").length||h.empty.fire()})}));1===a.nodeType&&("height"in
b||"width"in b)&&(c.overflow=[p.overflow,p.overflowX,p.overflowY],"inline"===k.css(a,"display")&&"none"===k.css(a,"float")&&(k.support.inlineBlockNeedsLayout&&"inline"!==U(a.nodeName)?p.zoom=1:p.display="inline-block"));c.overflow&&(p.overflow="hidden",k.support.shrinkWrapBlocks||g.always(function(){p.overflow=c.overflow[0];p.overflowX=c.overflow[1];p.overflowY=c.overflow[2]}));for(d in b)if(e=b[d],Md.exec(e))if(!(delete b[d],f=f||"toggle"===e,e===(m?"hide":"show")))n[d]=q&&q[d]||k.style(a,d);if(!k.isEmptyObject(n))for(d in q?
"hidden"in q&&(m=q.hidden):q=k._data(a,"fxshow",{}),f&&(q.hidden=!m),m?k(a).show():g.done(function(){k(a).hide()}),g.done(function(){var b;k._removeData(a,"fxshow");for(b in n)k.style(a,b,n[b])}),n)b=Sa(m?q[d]:0,d,g),d in q||(q[d]=b.start,m&&(b.end=b.start,b.start="width"===d||"height"===d?1:0))}],Ta={"*":[function(a,b){var c=this.createTween(a,b),d=c.cur(),e=Ec.exec(b),f=e&&e[3]||(k.cssNumber[a]?"":"px"),h=(k.cssNumber[a]||"px"!==f&&+d)&&Ec.exec(k.css(c.elem,a)),j=1,g=20;if(h&&h[3]!==f){f=f||h[3];
e=e||[];h=+d||1;do j=j||".5",h/=j,k.style(c.elem,a,h+f);while(j!==(j=c.cur()/d)&&1!==j&&--g)}return e&&(h=c.start=+h||+d||0,c.unit=f,c.end=e[1]?h+(e[1]+1)*e[2]:+e[2]),c}]};k.Animation=k.extend(R,{tweener:function(a,b){k.isFunction(a)?(b=a,a=["*"]):a=a.split(" ");for(var c,d=0,e=a.length;e>d;d++)c=a[d],Ta[c]=Ta[c]||[],Ta[c].unshift(b)},prefilter:function(a,b){b?Ya.unshift(a):Ya.push(a)}});k.Tween=G;G.prototype={constructor:G,init:function(a,b,c,d,e,f){this.elem=a;this.prop=c;this.easing=e||"swing";
...
this.each(b):this.queue(f.queue,b)},stop:function(a,c,d){var e=function(a){var b=a.stop;delete a.stop;b(d)};return"string"!=typeof a&&(d=c,c=a,a=b),c&&!1!==a&&this.queue(a||"fx",[]),this.each(function(){var b=!0,c=null!=a&&a+"queueHooks",f=k.timers,h=k._data(this);if(c)h[c]&&h[c].stop&&e(h[c]);else for(c in h)h[c]&&h[c].stop&&Nd.test(c)&&e(h[c]);for(c=f.length;c--;)f[c].elem!==this||null!=a&&f[c].queue!==a||(f[c].anim.stop(d),b=!1,f.splice(c,1));(b||!d)&&k.dequeue(this,a)})},finish:function(a){return!1!==
...
d.queue)},d};k.easing={linear:function(a){return a},swing:function(a){return 0.5-Math.cos(a*Math.PI)/2}};k.timers=[];k.fx=G.prototype.init;k.fx.tick=function(){var a,c=k.timers,d=0;for(Ka=k.now();c.length>d;d++)a=c[d],a()||c[d]!==a||c.splice(d--,1);c.length||k.fx.stop();Ka=b};k.fx.timer=function(a){a()&&k.timers.push(a)&&k.fx.start()};k.fx.interval=13;k.fx.start=function(){nb||(nb=setInterval(k.fx.tick,k.fx.interval))};k.fx.stop=function(){clearInterval(nb);nb=null};k.fx.speeds={slow:600,fast:200,
_default:400};k.fx.step={};k.expr&&k.expr.filters&&(k.expr.filters.animated=function(a){return k.grep(k.timers,function(b){return a===b.elem}).length});k.fn.offset=function(a){if(arguments.length)return a===b?this:this.each(function(b){k.offset.setOffset(this,a,b)});var c,d,e={top:0,left:0},f=this[0],h=f&&f.ownerDocument;if(h)return c=h.documentElement,k.contains(c,f)?(typeof f.getBoundingClientRect!==F&&(e=f.getBoundingClientRect()),d=K(h),{top:e.top+(d.pageYOffset||c.scrollTop)-(c.clientTop||0),
...
c.iOSNativeScrolling&&(b||(b={}),b.WebkitOverflowScrolling="touch");null!=b&&this.$content.css(b);return this};h.prototype.restore=function(){this.stopped=!1;this.pane.show();this.addEvents()};h.prototype.reset=function(){var a,b,c,f,h,g,r;this.$el.find("."+this.options.paneClass).length||this.generate().stop();this.stopped&&this.restore();a=this.content;c=a.style;f=c.overflowY;d&&this.$content.css({height:this.$content.height()});b=a.scrollHeight+e;g=this.pane.outerHeight();r=parseInt(this.pane.css("top"),
10);h=parseInt(this.pane.css("bottom"),10);h=g+r+h;r=Math.round(h/b*h);r<this.options.sliderMinHeight?r=this.options.sliderMinHeight:null!=this.options.sliderMaxHeight&&r>this.options.sliderMaxHeight&&(r=this.options.sliderMaxHeight);"scroll"===f&&"scroll"!==c.overflowX&&(r+=e);this.maxSliderTop=h-r;this.contentHeight=b;this.paneHeight=g;this.paneOuterHeight=h;this.sliderHeight=r;this.slider.height(r);this.events.scroll();this.pane.show();this.isActive=!0;a.scrollHeight===a.clientHeight||this.pane.outerHeight(!0)>=
...
e.options.disabled||a(this).hasClass("ui-state-disabled")))return("string"==typeof g?e[g]:g).apply(e,arguments)}"string"!=typeof g&&(q.guid=g.guid=g.guid||q.guid||a.guid++);var m=c.match(/^(\w+)\s*(.*)$/),s=m[1]+e.eventNamespace;(m=m[2])?d.delegate(m,s,q):b.bind(s,q)})},_off:function(a,b){b=(b||"").split(" ").join(this.eventNamespace+" ")+this.eventNamespace;a.unbind(b).undelegate(b)},_delay:function(a,b){var c=this;return setTimeout(function(){return("string"==typeof a?c[a]:a).apply(c,arguments)},
...
isWindow:c,offset:b.offset()||{left:0,top:0},scrollLeft:b.scrollLeft(),scrollTop:b.scrollTop(),width:c?b.width():b.outerWidth(),height:c?b.height():b.outerHeight()}}};a.fn.position=function(b){if(!b||!b.of)return m.apply(this,arguments);var b=a.extend({},b),d,q,t,s,r,w=a(b.of),u=a.position.getWithinInfo(b.within),y=a.position.getScrollInfo(u),v=w[0],Q=(b.collision||"flip").split(" "),ba={};return 9===v.nodeType?(q=w.width(),t=w.height(),s={top:0,left:0}):a.isWindow(v)?(q=w.width(),t=w.height(),s=
{top:w.scrollTop(),left:w.scrollLeft()}):v.preventDefault?(b.at="left top",q=t=0,s={top:v.pageY,left:v.pageX}):(q=w.outerWidth(),t=w.outerHeight(),s=w.offset()),r=a.extend({},s),a.each(["my","at"],function(){var a=(b[this]||"").split(" "),c,d;1===a.length&&(a=h.test(a[0])?a.concat(["center"]):j.test(a[0])?["center"].concat(a):["center","center"]);a[0]=h.test(a[0])?a[0]:"center";a[1]=j.test(a[1])?a[1]:"center";c=n.exec(a[0]);d=n.exec(a[1]);ba[this]=[c?c[0]:0,d?d[0]:0];b[this]=[p.exec(a[0])[0],p.exec(a[1])[0]]}),
1===Q.length&&(Q[1]=Q[0]),"right"===b.at[0]?r.left+=q:"center"===b.at[0]&&(r.left+=q/2),"bottom"===b.at[1]?r.top+=t:"center"===b.at[1]&&(r.top+=t/2),d=c(ba.at,q,t),r.left+=d[0],r.top+=d[1],this.each(function(){var h,j,n=a(this),p=n.outerWidth(),m=n.outerHeight(),v=parseInt(a.css(this,"marginLeft"),10)||0,ha=parseInt(a.css(this,"marginTop"),10)||0,na=p+v+(parseInt(a.css(this,"marginRight"),10)||0)+y.width,ra=m+ha+(parseInt(a.css(this,"marginBottom"),10)||0)+y.height,F=a.extend({},r),ca=c(ba.my,n.outerWidth(),
n.outerHeight());"right"===b.my[0]?F.left-=p:"center"===b.my[0]&&(F.left-=p/2);"bottom"===b.my[1]?F.top-=m:"center"===b.my[1]&&(F.top-=m/2);F.left+=ca[0];F.top+=ca[1];a.support.offsetFractions||(F.left=g(F.left),F.top=g(F.top));h={marginLeft:v,marginTop:ha};a.each(["left","top"],function(c,e){a.ui.position[Q[c]]&&a.ui.position[Q[c]][e](F,{targetWidth:q,targetHeight:t,elemWidth:p,elemHeight:m,collisionPosition:h,collisionWidth:na,collisionHeight:ra,offset:[d[0]+ca[0],d[1]+ca[1]],my:b.my,at:b.at,within:u,
elem:n})});a.fn.bgiframe&&n.bgiframe();b.using&&(j=function(a){var c=s.left-F.left,d=c+q-p,h=s.top-F.top,g=h+t-m,j={target:{element:w,left:s.left,top:s.top,width:q,height:t},element:{element:n,left:F.left,top:F.top,width:p,height:m},horizontal:0>d?"left":0<c?"right":"center",vertical:0>g?"top":0<h?"bottom":"middle"};q<p&&f(c+d)<q&&(j.horizontal="center");t<m&&f(h+g)<t&&(j.vertical="middle");e(f(c),f(d))>e(f(h),f(g))?j.important="horizontal":j.important="vertical";b.using.call(this,a,j)});n.offset(a.extend(F,
...
b.at[1]?-b.targetHeight:0,p=-2*b.offset[1],m,q;0>g?(q=a.top+j+n+p+b.collisionHeight-e-d,a.top+j+n+p>g&&(0>q||q<f(g))&&(a.top+=j+n+p)):0<h&&(m=a.top-b.collisionPosition.marginTop+j+n+p-c,a.top+j+n+p>h&&(0<m||f(m)<h)&&(a.top+=j+n+p))}},flipfit:{left:function(){a.ui.position.flip.left.apply(this,arguments);a.ui.position.fit.left.apply(this,arguments)},top:function(){a.ui.position.flip.top.apply(this,arguments);a.ui.position.fit.top.apply(this,arguments)}}};var s,r,u,v,t=document.getElementsByTagName("body")[0];
u=document.createElement("div");s=document.createElement(t?"div":"body");r={visibility:"hidden",width:0,height:0,border:0,margin:0,background:"none"};t&&a.extend(r,{position:"absolute",left:"-1000px",top:"-1000px"});for(v in r)s.style[v]=r[v];s.appendChild(u);r=t||document.documentElement;r.insertBefore(s,r.firstChild);u.style.cssText="position: absolute; left: 10.7432222px;";u=a(u).offset().left;a.support.offsetFractions=10<u&&11>u;s.innerHTML="";r.removeChild(s);if(!1!==a.uiBackCompat){var w=jQuery,
...
d.snapElements[p].left,m=q+d.snapElements[p].width,s=d.snapElements[p].top,r=s+d.snapElements[p].height;if(q-f<g&&g<m+f&&s-f<j&&j<r+f||q-f<g&&g<m+f&&s-f<n&&n<r+f||q-f<h&&h<m+f&&s-f<j&&j<r+f||q-f<h&&h<m+f&&s-f<n&&n<r+f){if("inner"!=e.snapMode){var u=Math.abs(s-n)<=f,v=Math.abs(r-j)<=f,t=Math.abs(q-h)<=f,w=Math.abs(m-g)<=f;u&&(c.position.top=d._convertPositionTo("relative",{top:s-d.helperProportions.height,left:0}).top-d.margins.top);v&&(c.position.top=d._convertPositionTo("relative",{top:r,left:0}).top-
d.margins.top);t&&(c.position.left=d._convertPositionTo("relative",{top:0,left:q-d.helperProportions.width}).left-d.margins.left);w&&(c.position.left=d._convertPositionTo("relative",{top:0,left:m}).left-d.margins.left)}var y=u||v||t||w;"outer"!=e.snapMode&&(u=Math.abs(s-j)<=f,v=Math.abs(r-n)<=f,t=Math.abs(q-g)<=f,w=Math.abs(m-h)<=f,u&&(c.position.top=d._convertPositionTo("relative",{top:s,left:0}).top-d.margins.top),v&&(c.position.top=d._convertPositionTo("relative",{top:r-d.helperProportions.height,
left:0}).top-d.margins.top),t&&(c.position.left=d._convertPositionTo("relative",{top:0,left:q}).left-d.margins.left),w&&(c.position.left=d._convertPositionTo("relative",{top:0,left:m-d.helperProportions.width}).left-d.margins.left));!d.snapElements[p].snapping&&(u||v||t||w||y)&&d.options.snap.snap&&d.options.snap.snap.call(d.element,b,a.extend(d._uiHash(),{snapItem:d.snapElements[p].item}));d.snapElements[p].snapping=u||v||t||w||y}else d.snapElements[p].snapping&&d.options.snap.release&&d.options.snap.release.call(d.element,
...
d?a.extend({},a.datepicker._defaults):g?"all"==d?a.extend({},g.settings):this._get(g,d):null;var q=d||{};"string"==typeof d&&(q={},q[d]=f);if(g){this._curInst==g&&this._hideDatepicker();var m=this._getDateDatepicker(c,!0),s=this._getMinMaxDate(g,"min"),r=this._getMinMaxDate(g,"max");e(g.settings,q);null!==s&&q.dateFormat!==b&&q.minDate===b&&(g.settings.minDate=this._formatDate(g,s));null!==r&&q.dateFormat!==b&&q.maxDate===b&&(g.settings.maxDate=this._formatDate(g,r));this._attachments(a(c),g);this._autoSize(g);
...
b.input.focus();if(b.yearshtml){var e=b.yearshtml;setTimeout(function(){e===b.yearshtml&&b.yearshtml&&b.dpDiv.find("select.ui-datepicker-year:first").replaceWith(b.yearshtml);e=b.yearshtml=null},0)}},_getBorders:function(a){var b=function(a){return{thin:1,medium:2,thick:3}[a]||a};return[parseFloat(b(a.css("border-left-width"))),parseFloat(b(a.css("border-top-width")))]},_checkOffset:function(b,c,d){var e=b.dpDiv.outerWidth(),f=b.dpDiv.outerHeight(),g=b.input?b.input.outerWidth():0,s=b.input?b.input.outerHeight():
0,r=document.documentElement.clientWidth+(d?0:a(document).scrollLeft()),u=document.documentElement.clientHeight+(d?0:a(document).scrollTop());return c.left-=this._get(b,"isRTL")?e-g:0,c.left-=d&&c.left==b.input.offset().left?a(document).scrollLeft():0,c.top-=d&&c.top==b.input.offset().top+s?a(document).scrollTop():0,c.left-=Math.min(c.left,c.left+e>r&&r>e?Math.abs(c.left+e-r):0),c.top-=Math.min(c.top,c.top+f>u&&u>f?Math.abs(f+s):0),c},_findPos:function(b){for(var c=this._getInst(b),c=this._get(c,
...
c="object"==typeof c?c.toString():c+"";if(""==c)return null;for(var e=(d?d.shortYearCutoff:null)||this._defaults.shortYearCutoff,e="string"!=typeof e?e:(new Date).getFullYear()%100+parseInt(e,10),f=(d?d.dayNamesShort:null)||this._defaults.dayNamesShort,g=(d?d.dayNames:null)||this._defaults.dayNames,s=(d?d.monthNamesShort:null)||this._defaults.monthNamesShort,r=(d?d.monthNames:null)||this._defaults.monthNames,u=d=-1,v=-1,t=-1,w=!1,y=function(a){a=O+1<b.length&&b.charAt(O+1)==a;return a&&O++,a},B=function(a){var b=
y(a),a=RegExp("^\\d{1,"+("@"==a?14:"!"==a?20:"y"==a&&b?4:"o"==a?3:2)+"}"),a=c.substring(N).match(a);if(!a)throw"Missing number at position "+N;return N+=a[0].length,parseInt(a[0],10)},C=function(b,d,e){var b=a.map(y(b)?e:d,function(a,b){return[[b,a]]}).sort(function(a,b){return-(a[1].length-b[1].length)}),f=-1;a.each(b,function(a,b){var d=b[1];if(c.substr(N,d.length).toLowerCase()==d.toLowerCase())return f=b[0],N+=d.length,!1});if(-1!=f)return f+1;throw"Unknown name at position "+N;},x=function(){if(c.charAt(N)!=
b.charAt(O))throw"Unexpected literal at position "+N;N++},N=0,O=0;O<b.length;O++)if(w)"'"==b.charAt(O)&&!y("'")?w=!1:x();else switch(b.charAt(O)){case "d":v=B("d");break;case "D":C("D",f,g);break;case "o":t=B("o");break;case "m":u=B("m");break;case "M":u=C("M",s,r);break;case "y":d=B("y");break;case "@":var z=new Date(B("@")),d=z.getFullYear(),u=z.getMonth()+1,v=z.getDate();break;case "!":z=new Date((B("!")-this._ticksTo1970)/1E4);d=z.getFullYear();u=z.getMonth()+1;v=z.getDate();break;case "'":y("'")?
x():w=!0;break;default:x()}if(N<c.length&&(f=c.substr(N),!/^\s+/.test(f)))throw"Extra/unparsed characters found in date: "+f;-1==d?d=(new Date).getFullYear():100>d&&(d+=(new Date).getFullYear()-(new Date).getFullYear()%100+(d<=e?0:-100));if(-1<t){u=1;v=t;do{e=this._getDaysInMonth(d,u-1);if(v<=e)break;u++;v-=e}while(1)}z=this._daylightSavingAdjust(new Date(d,u-1,v));if(z.getFullYear()!=d||z.getMonth()+1!=u||z.getDate()!=v)throw"Invalid date";return z},ATOM:"yy-mm-dd",COOKIE:"D, dd M yy",ISO_8601:"yy-mm-dd",
...
function(b){b=t+1<a.length&&a.charAt(t+1)==b;return b&&t++,b},r=function(a,b,c){b=""+b;if(g(a))for(;b.length<c;)b="0"+b;return b},u="",v=!1;if(b)for(var t=0;t<a.length;t++)if(v)"'"==a.charAt(t)&&!g("'")?v=!1:u+=a.charAt(t);else switch(a.charAt(t)){case "d":u+=r("d",b.getDate(),2);break;case "D":var w;w=b.getDay();var y=d,B=e;w=g("D")?B[w]:y[w];u+=w;break;case "o":u+=r("o",Math.round(((new Date(b.getFullYear(),b.getMonth(),b.getDate())).getTime()-(new Date(b.getFullYear(),0,0)).getTime())/864E5),3);
break;case "m":u+=r("m",b.getMonth()+1,2);break;case "M":w=b.getMonth();y=f;B=c;w=g("M")?B[w]:y[w];u+=w;break;case "y":u+=g("y")?b.getFullYear():(10>b.getYear()%100?"0":"")+b.getYear()%100;break;case "@":u+=b.getTime();break;case "!":u+=1E4*b.getTime()+this._ticksTo1970;break;case "'":g("'")?u+="'":v=!0;break;default:u+=a.charAt(t)}return u},_possibleChars:function(a){for(var b="",c=!1,d=function(b){b=e+1<a.length&&a.charAt(e+1)==b;return b&&e++,b},e=0;e<a.length;e++)if(c)"'"==a.charAt(e)&&!d("'")?
...
g=this._get(b,"navigationAsDateFormat"),s=this._getNumberOfMonths(b),r=this._get(b,"showCurrentAtPos"),u=this._get(b,"stepMonths"),v=1!=s[0]||1!=s[1],t=this._daylightSavingAdjust(b.currentDay?new Date(b.currentYear,b.currentMonth,b.currentDay):new Date(9999,9,9)),w=this._getMinMaxDate(b,"min"),y=this._getMinMaxDate(b,"max"),r=b.drawMonth-r,B=b.drawYear;0>r&&(r+=12,B--);if(y)for(var C=this._daylightSavingAdjust(new Date(y.getFullYear(),y.getMonth()-s[0]*s[1]+1,y.getDate())),C=w&&C<w?w:C;this._daylightSavingAdjust(new Date(B,
r,1))>C;)r--,0>r&&(r=11,B--);b.drawMonth=r;b.drawYear=B;var C=this._get(b,"prevText"),C=g?this.formatDate(C,this._daylightSavingAdjust(new Date(B,r-u,1)),this._getFormatConfig(b)):C,C=this._canAdjustMonth(b,-1,B,r)?'<a class="ui-datepicker-prev ui-corner-all" data-handler="prev" data-event="click" title="'+C+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"e":"w")+'">'+C+"</span></a>":f?"":'<a class="ui-datepicker-prev ui-corner-all ui-state-disabled" title="'+C+'"><span class="ui-icon ui-icon-circle-triangle-'+
(d?"e":"w")+'">'+C+"</span></a>",x=this._get(b,"nextText"),x=g?this.formatDate(x,this._daylightSavingAdjust(new Date(B,r+u,1)),this._getFormatConfig(b)):x,f=this._canAdjustMonth(b,1,B,r)?'<a class="ui-datepicker-next ui-corner-all" data-handler="next" data-event="click" title="'+x+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"w":"e")+'">'+x+"</span></a>":f?"":'<a class="ui-datepicker-next ui-corner-all ui-state-disabled" title="'+x+'"><span class="ui-icon ui-icon-circle-triangle-'+(d?"w":
"e")+'">'+x+"</span></a>",u=this._get(b,"currentText"),x=this._get(b,"gotoCurrent")&&b.currentDay?t:c,u=g?this.formatDate(u,x,this._getFormatConfig(b)):u,g=b.inline?"":'<button type="button" class="ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all" data-handler="hide" data-event="click">'+this._get(b,"closeText")+"</button>",e=e?'<div class="ui-datepicker-buttonpane ui-widget-content">'+(d?g:"")+(this._isInRange(b,x)?'<button type="button" class="ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all" data-handler="today" data-event="click">'+
u+"</button>":"")+(d?"":g)+"</div>":"",g=parseInt(this._get(b,"firstDay"),10),g=isNaN(g)?0:g,u=this._get(b,"showWeek"),x=this._get(b,"dayNames");this._get(b,"dayNamesShort");var N=this._get(b,"dayNamesMin"),O=this._get(b,"monthNames"),z=this._get(b,"monthNamesShort"),U=this._get(b,"beforeShowDay"),aa=this._get(b,"showOtherMonths"),Ra=this._get(b,"selectOtherMonths");this._get(b,"calculateWeek");for(var ha=this._getDefaultDate(b),Q="",ba=0;ba<s[0];ba++){var X="";this.maxRows=4;for(var qa=0;qa<s[1];qa++){var Sa=
this._daylightSavingAdjust(new Date(B,r,b.selectedDay)),R=" ui-corner-all",G="";if(v){G+='<div class="ui-datepicker-group';if(1<s[1])switch(qa){case 0:G+=" ui-datepicker-group-first";R=" ui-corner-"+(d?"right":"left");break;case s[1]-1:G+=" ui-datepicker-group-last";R=" ui-corner-"+(d?"left":"right");break;default:G+=" ui-datepicker-group-middle",R=""}G+='">'}for(var G=G+('<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix'+R+'">'+(/all|left/.test(R)&&0==ba?d?f:C:"")+(/all|right/.test(R)&&
0==ba?d?C:f:"")+this._generateMonthYearHeader(b,r,B,w,y,0<ba||0<qa,O,z)+'</div><table class="ui-datepicker-calendar"><thead><tr>'),T=u?'<th class="ui-datepicker-week-col">'+this._get(b,"weekHeader")+"</th>":"",R=0;7>R;R++)var K=(R+g)%7,T=T+("<th"+(5<=(R+g+6)%7?' class="ui-datepicker-week-end"':"")+'><span title="'+x[K]+'">'+N[K]+"</span></th>");G+=T+"</tr></thead><tbody>";T=this._getDaysInMonth(B,r);B==b.selectedYear&&r==b.selectedMonth&&(b.selectedDay=Math.min(b.selectedDay,T));R=(this._getFirstDayOfMonth(B,
r)-g+7)%7;T=Math.ceil((R+T)/7);this.maxRows=T=v?this.maxRows>T?this.maxRows:T:T;for(var K=this._daylightSavingAdjust(new Date(B,r,1-R)),na=0;na<T;na++){for(var G=G+"<tr>",ra=u?'<td class="ui-datepicker-week-col">'+this._get(b,"calculateWeek")(K)+"</td>":"",R=0;7>R;R++){var F=U?U.apply(b.input?b.input[0]:null,[K]):[!0,""],ca=K.getMonth()!=r,A=ca&&!Ra||!F[0]||w&&K<w||y&&K>y,ra=ra+('<td class="'+(5<=(R+g+6)%7?" ui-datepicker-week-end":"")+(ca?" ui-datepicker-other-month":"")+(K.getTime()==Sa.getTime()&&
r==b.selectedMonth&&b._keyEvent||ha.getTime()==K.getTime()&&ha.getTime()==Sa.getTime()?" "+this._dayOverClass:"")+(A?" "+this._unselectableClass+" ui-state-disabled":"")+(ca&&!aa?"":" "+F[1]+(K.getTime()==t.getTime()?" "+this._currentClass:"")+(K.getTime()==c.getTime()?" ui-datepicker-today":""))+'"'+((!ca||aa)&&F[2]?' title="'+F[2]+'"':"")+(A?"":' data-handler="selectDay" data-event="click" data-month="'+K.getMonth()+'" data-year="'+K.getFullYear()+'"')+">"+(ca&&!aa?"&#xa0;":A?'<span class="ui-state-default">'+
K.getDate()+"</span>":'<a class="ui-state-default'+(K.getTime()==c.getTime()?" ui-state-highlight":"")+(K.getTime()==t.getTime()?" ui-state-active":"")+(ca?" ui-priority-secondary":"")+'" href="#">'+K.getDate()+"</a>")+"</td>");K.setDate(K.getDate()+1);K=this._daylightSavingAdjust(K)}G+=ra+"</tr>"}r++;11<r&&(r=0,B++);G+="</tbody></table>"+(v?"</div>"+(0<s[0]&&qa==s[1]-1?'<div class="ui-datepicker-row-break"></div>':""):"");X+=G}Q+=X}return Q+=e+(a.ui.ie6&&!b.inline?'<iframe src="javascript:false;" class="ui-datepicker-cover" frameborder="0"></iframe>':
""),b._keyEvent=!1,Q},_generateMonthYearHeader:function(a,b,c,d,e,f,g,r){var u=this._get(a,"changeMonth"),v=this._get(a,"changeYear"),t=this._get(a,"showMonthAfterYear"),w='<div class="ui-datepicker-title">',y="";if(f||!u)y+='<span class="ui-datepicker-month">'+g[b]+"</span>";else{for(var g=d&&d.getFullYear()==c,B=e&&e.getFullYear()==c,y=y+'<select class="ui-datepicker-month" data-handler="selectMonth" data-event="change">',C=0;12>C;C++)(!g||C>=d.getMonth())&&(!B||C<=e.getMonth())&&(y+='<option value="'+
C+'"'+(C==b?' selected="selected"':"")+">"+r[C]+"</option>");y+="</select>"}t||(w+=y+(f||!u||!v?"&#xa0;":""));if(!a.yearshtml)if(a.yearshtml="",f||!v)w+='<span class="ui-datepicker-year">'+c+"</span>";else{var r=this._get(a,"yearRange").split(":"),x=(new Date).getFullYear(),g=function(a){a=a.match(/c[+-].*/)?c+parseInt(a.substring(1),10):a.match(/[+-].*/)?x+parseInt(a,10):parseInt(a,10);return isNaN(a)?x:a},b=g(r[0]),r=Math.max(b,g(r[1]||"")),b=d?Math.max(b,d.getFullYear()):b,r=e?Math.min(r,e.getFullYear()):
r;for(a.yearshtml+='<select class="ui-datepicker-year" data-handler="selectYear" data-event="change">';b<=r;b++)a.yearshtml+='<option value="'+b+'"'+(b==c?' selected="selected"':"")+">"+b+"</option>";a.yearshtml+="</select>";w+=a.yearshtml;a.yearshtml=null}return w+=this._get(a,"yearSuffix"),t&&(w+=(f||!u||!v?"&#xa0;":"")+y),w+="</div>",w},_adjustInstDate:function(a,b,c){var d=a.drawYear+("Y"==c?b:0),e=a.drawMonth+("M"==c?b:0),b=Math.min(a.selectedDay,this._getDaysInMonth(d,e))+("D"==c?b:0),d=this._restrictMinMax(a,
...
jQuery.effects||function(a,b){var c=!1!==a.uiBackCompat;a.effects={effect:{}};var d=jQuery,e=function(a,b,c){var d=q[b.type]||{};return null==a?c||!b.def?null:b.def:(a=d.floor?~~a:parseFloat(a),isNaN(a)?b.def:d.mod?(a+d.mod)%d.mod:0>a?0:d.max<a?d.max:a)},f=function(a){var b=n(),c=b._rgba=[];return a=a.toLowerCase(),u(j,function(d,e){var f,h=e.re.exec(a),h=h&&e.parse(h),g=e.space||"rgba";if(h)return f=b[g](h),b[p[g].cache]=f[p[g].cache],c=b._rgba=f._rgba,!1}),c.length?("0,0,0,0"===c.join()&&d.extend(c,
r.transparent),b):r[a]},g=function(a,b,c){return c=(c+1)%1,1>6*c?a+6*(b-a)*c:1>2*c?b:2>3*c?a+6*(b-a)*(2/3-c):a},h=/^([\-+])=\s*(\d+\.?\d*)/,j=[{re:/rgba?\(\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*(?:,\s*(\d+(?:\.\d+)?)\s*)?\)/,parse:function(a){return[a[1],a[2],a[3],a[4]]}},{re:/rgba?\(\s*(\d+(?:\.\d+)?)\%\s*,\s*(\d+(?:\.\d+)?)\%\s*,\s*(\d+(?:\.\d+)?)\%\s*(?:,\s*(\d+(?:\.\d+)?)\s*)?\)/,parse:function(a){return[2.55*a[1],2.55*a[2],2.55*a[3],a[4]]}},{re:/#([a-f0-9]{2})([a-f0-9]{2})([a-f0-9]{2})/,
...
green:{idx:1,type:"byte"},blue:{idx:2,type:"byte"}}},hsla:{props:{hue:{idx:0,type:"degrees"},saturation:{idx:1,type:"percent"},lightness:{idx:2,type:"percent"}}}},q={"byte":{floor:!0,max:255},percent:{max:1},degrees:{mod:360,floor:!0}},m=n.support={},s=d("<p>")[0],r,u=d.each;s.style.cssText="background-color:rgba(1,1,1,.5)";m.rgba=-1<s.style.backgroundColor.indexOf("rgba");u(p,function(a,b){b.cache="_"+a;b.props.alpha={idx:3,type:"percent",def:1}});n.fn=d.extend(n.prototype,{parse:function(b,c,h,
g){if(void 0===b)return this._rgba=[null,null,null,null],this;if(b.jquery||b.nodeType)b=d(b).css(c),c=void 0;var j=this,m=d.type(b),q=this._rgba=[];void 0!==c&&(b=[b,c,h,g],m="array");if("string"===m)return this.parse(f(b)||r._default);if("array"===m)return u(p.rgba.props,function(a,c){q[c.idx]=e(b[c.idx],c)}),this;if("object"===m)return b instanceof n?u(p,function(a,c){b[c.cache]&&(j[c.cache]=b[c.cache].slice())}):u(p,function(c,d){var f=d.cache;u(d.props,function(a,c){if(!j[f]&&d.to){if("alpha"===
a||null==b[a])return;j[f]=d.to(j._rgba)}j[f][c.idx]=e(b[a],c,!0)});j[f]&&0>a.inArray(null,j[f].slice(0,3))&&(j[f][3]=1,d.from&&(j._rgba=d.from(j[f])))}),this},is:function(a){var b=n(a),c=!0,d=this;return u(p,function(a,e){var f,h=b[e.cache];return h&&(f=d[e.cache]||e.to&&e.to(d._rgba)||[],u(e.props,function(a,b){if(null!=h[b.idx])return c=h[b.idx]===f[b.idx],c})),c}),c},_space:function(){var a=[],b=this;return u(p,function(c,d){b[d.cache]&&a.push(c)}),a.pop()},transition:function(a,b){var c=n(a),
d=c._space(),f=p[d],h=0===this.alpha()?n("transparent"):this,g=h[f.cache]||f.to(h._rgba),j=g.slice();return c=c[f.cache],u(f.props,function(a,d){var f=d.idx,h=g[f],n=c[f],m=q[d.type]||{};null!==n&&(null===h?j[f]=n:(m.mod&&(n-h>m.mod/2?h+=m.mod:h-n>m.mod/2&&(h-=m.mod)),j[f]=e((n-h)*b+h,d)))}),this[d](j)},blend:function(a){if(1===this._rgba[3])return this;var b=this._rgba.slice(),c=b.pop(),e=n(a)._rgba;return n(d.map(b,function(a,b){return(1-c)*e[b]+c*a}))},toRgbaString:function(){var a="rgba(",b=d.map(this._rgba,
...
"transparent":this.toRgbaString()}});n.fn.parse.prototype=n.fn;p.hsla.to=function(a){if(null==a[0]||null==a[1]||null==a[2])return[null,null,null,a[3]];var b=a[0]/255,c=a[1]/255,d=a[2]/255,a=a[3],e=Math.max(b,c,d),f=Math.min(b,c,d),h=e-f,g=e+f,j=0.5*g,n,m;return f===e?n=0:b===e?n=60*(c-d)/h+360:c===e?n=60*(d-b)/h+120:n=60*(b-c)/h+240,0===j||1===j?m=j:0.5>=j?m=h/g:m=h/(2-g),[Math.round(n)%360,m,j,null==a?1:a]};p.hsla.from=function(a){if(null==a[0]||null==a[1]||null==a[2])return[null,null,null,a[3]];
var b=a[0]/360,c=a[1],d=a[2],a=a[3],c=0.5>=d?d*(1+c):d+c-d*c,d=2*d-c;return[Math.round(255*g(d,c,b+1/3)),Math.round(255*g(d,c,b)),Math.round(255*g(d,c,b-1/3)),a]};u(p,function(a,b){var c=b.props,f=b.cache,g=b.to,j=b.from;n.fn[a]=function(a){g&&!this[f]&&(this[f]=g(this._rgba));if(void 0===a)return this[f].slice();var b,h=d.type(a),m="array"===h||"object"===h?a:arguments,p=this[f].slice();return u(c,function(a,b){var c=m["object"===h?a:b.idx];null==c&&(c=p[b.idx]);p[b.idx]=e(c,b)}),j?(b=n(j(p)),b[f]=
p,b):n(p)};u(c,function(b,c){n.fn[b]||(n.fn[b]=function(e){var f=d.type(e),g="alpha"===b?this._hsla?"hsla":"rgba":a,j=this[g](),n=j[c.idx],m;return"undefined"===f?n:("function"===f&&(e=e.call(this,n),f=d.type(e)),null==e&&c.empty?this:("string"===f&&(m=h.exec(e),m&&(e=n+parseFloat(m[2])*("+"===m[1]?1:-1))),j[c.idx]=e,this[g](j)))})})});u("backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor".split(" "),
...
a.effects.effect[d.effect],g=!h&&c&&a.effects[d.effect];return a.fx.off||!h&&!g?e?this[e](d.duration,d.complete):this.each(function(){d.complete&&d.complete.call(this)}):h?!1===f?this.each(b):this.queue(f||"fx",b):g.call(this,{options:d,duration:d.duration,callback:d.complete,mode:d.mode})},_show:a.fn.show,show:function(a){if(B(a))return this._show.apply(this,arguments);var b=y.apply(this,arguments);return b.mode="show",this.effect.call(this,b)},_hide:a.fn.hide,hide:function(a){if(B(a))return this._hide.apply(this,
arguments);var b=y.apply(this,arguments);return b.mode="hide",this.effect.call(this,b)},__toggle:a.fn.toggle,toggle:function(b){if(B(b)||"boolean"==typeof b||a.isFunction(b))return this.__toggle.apply(this,arguments);var c=y.apply(this,arguments);return c.mode="toggle",this.effect.call(this,c)},cssUnit:function(b){var c=this.css(b),d=[];return a.each(["em","px","%","pt"],function(a,b){0<c.indexOf(b)&&(d=[parseFloat(c),b])}),d}});var C={};a.each(["Quad","Cubic","Quart","Quint","Expo"],function(a,b){C[b]=
function(b){return Math.pow(b,a+2)}});a.extend(C,{Sine:function(a){return 1-Math.cos(a*Math.PI/2)},Circ:function(a){return 1-Math.sqrt(1-a*a)},Elastic:function(a){return 0===a||1===a?a:-Math.pow(2,8*(a-1))*Math.sin((80*(a-1)-7.5)*Math.PI/15)},Back:function(a){return a*a*(3*a-2)},Bounce:function(a){for(var b,c=4;a<((b=Math.pow(2,--c))-1)/11;);return 1/Math.pow(4,3-c)-7.5625*Math.pow((3*b-2)/22-a,2)}});a.each(C,function(b,c){a.easing["easeIn"+b]=c;a.easing["easeOut"+b]=function(a){return 1-c(1-a)};
...
d)},bounds:function(b,c){var d;d="undefined"!==typeof b&&b instanceof Date&&"undefined"!==typeof c&&c instanceof Date?a.ui.rangeSlider.prototype.bounds.apply(this,[b.valueOf(),c.valueOf()]):a.ui.rangeSlider.prototype.bounds.apply(this,this._toArray(arguments));this._setBounds(b,c);this._initWidth();this._changed(!0);return{min:new Date(d.min),max:new Date(d.max)}}})})(jQuery);"object"!==typeof JSON&&(JSON={});
(function(){function a(a){return 10>a?"0"+a:a}function b(a){e.lastIndex=0;return e.test(a)?'"'+a.replace(e,function(a){var b=h[a];return"string"===typeof b?b:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function c(a,d){var e,h,s,r,u=f,v,t=d[a];t&&("object"===typeof t&&"function"===typeof t.toJSON)&&(t=t.toJSON(a));"function"===typeof j&&(t=j.call(d,a,t));switch(typeof t){case "string":return b(t);case "number":return isFinite(t)?String(t):"null";case "boolean":case "null":return String(t);
case "object":if(!t)return"null";f+=g;v=[];if("[object Array]"===Object.prototype.toString.apply(t)){r=t.length;for(e=0;e<r;e+=1)v[e]=c(e,t)||"null";s=0===v.length?"[]":f?"[\n"+f+v.join(",\n"+f)+"\n"+u+"]":"["+v.join(",")+"]";f=u;return s}if(j&&"object"===typeof j){r=j.length;for(e=0;e<r;e+=1)"string"===typeof j[e]&&(h=j[e],(s=c(h,t))&&v.push(b(h)+(f?": ":":")+s))}else for(h in t)Object.prototype.hasOwnProperty.call(t,h)&&(s=c(h,t))&&v.push(b(h)+(f?": ":":")+s);s=0===v.length?"{}":f?"{\n"+f+v.join(",\n"+
f)+"\n"+u+"}":"{"+v.join(",")+"}";f=u;return s}}"function"!==typeof Date.prototype.toJSON&&(Date.prototype.toJSON=function(){return isFinite(this.valueOf())?this.getUTCFullYear()+"-"+a(this.getUTCMonth()+1)+"-"+a(this.getUTCDate())+"T"+a(this.getUTCHours())+":"+a(this.getUTCMinutes())+":"+a(this.getUTCSeconds())+"Z":null},String.prototype.toJSON=Number.prototype.toJSON=Boolean.prototype.toJSON=function(){return this.valueOf()});var d=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
...
(function(a,b){var c=a.console||b,d=a.document,e=a.navigator,f=!1,g=a.setTimeout,h=a.clearTimeout,j=a.setInterval,n=a.clearInterval,p=a.JSON,q=a.alert,m=a.History=a.History||{},s=a.history;try{f=a.sessionStorage,f.setItem("TEST","1"),f.removeItem("TEST")}catch(r){f=!1}p.stringify=p.stringify||p.encode;p.parse=p.parse||p.decode;if("undefined"!==typeof m.init)throw Error("History.js Core has already been loaded...");m.init=function(){if("undefined"===typeof m.Adapter)return!1;"undefined"!==typeof m.initCore&&
...
s.go(-1);return!0};m.forward=function(a){if(!1!==a&&m.busy())return m.pushQueue({scope:m,callback:m.forward,args:arguments,queue:a}),!1;m.busy(!0);m.doubleCheck(function(){m.forward(!1)});s.go(1);return!0};m.go=function(a,b){var c;if(0<a)for(c=1;c<=a;++c)m.forward(b);else if(0>a)for(c=-1;c>=a;--c)m.back(b);else throw Error("History.go: History.go requires a positive or negative integer passed.");return m};if(m.emulated.pushState){var r=function(){};m.pushState=m.pushState||r;m.replaceState=m.replaceState||
r}else m.onPopState=function(b,c){var d=!1,d=!1;m.doubleCheckComplete();if(d=m.getHash())return(d=m.extractState(d||m.getLocationHref(),!0))?m.replaceState(d.data,d.title,d.url,!1):(m.Adapter.trigger(a,"anchorchange"),m.busy(!1)),m.expectedStateId=!1;(d=(d=m.Adapter.extractEventData("state",b,c)||!1)?m.getStateById(d):m.expectedStateId?m.getStateById(m.expectedStateId):m.extractState(m.getLocationHref()))||(d=m.createStateObject(null,null,m.getLocationHref()));m.expectedStateId=!1;if(m.isLastSavedState(d))return m.busy(!1),
...
m.expectedStateId=f.id,s.pushState(f.id,f.title,f.url),m.Adapter.trigger(a,"popstate"));return!0},m.replaceState=function(b,c,d,e){if(m.getHashByUrl(d)&&m.emulated.pushState)throw Error("History.js does not support states with fragement-identifiers (hashes/anchors).");if(!1!==e&&m.busy())return m.pushQueue({scope:m,callback:m.replaceState,args:arguments,queue:e}),!1;m.busy(!0);var f=m.createStateObject(b,c,d);m.isLastSavedState(f)?m.busy(!1):(m.storeState(f),m.expectedStateId=f.id,s.replaceState(f.id,
...
(function(a){a.fn.visible=function(b,c,d){var e=a(this).eq(0),f=e.get(0),g=a(window),h=g.scrollTop(),j=h+g.height(),n=g.scrollLeft(),g=n+g.width(),p=e.offset().top,q=p+e.height(),m=e.offset().left,s=m+e.width(),e=!0===b?q:p,p=!0===b?p:q,q=!0===b?s:m,b=!0===b?m:s,c=!0===c?f.offsetWidth*f.offsetHeight:!0,d=d?d:"both";if("both"===d)return!!c&&p<=j&&e>=h&&b<=g&&q>=n;if("vertical"===d)return!!c&&p<=j&&e>=h;if("horizontal"===d)return!!c&&b<=g&&q>=n}})(jQuery);
...
OpenLayers.Util.distVincenty=function(a,b){for(var c=OpenLayers.Util.VincentyConstants,d=c.a,e=c.b,c=c.f,f=OpenLayers.Util.rad(b.lon-a.lon),g=Math.atan((1-c)*Math.tan(OpenLayers.Util.rad(a.lat))),h=Math.atan((1-c)*Math.tan(OpenLayers.Util.rad(b.lat))),j=Math.sin(g),g=Math.cos(g),n=Math.sin(h),h=Math.cos(h),p=f,q=2*Math.PI,m=20;1E-12<Math.abs(p-q)&&0<--m;){var s=Math.sin(p),r=Math.cos(p),u=Math.sqrt(h*s*h*s+(g*n-j*h*r)*(g*n-j*h*r));if(0==u)return 0;var r=j*n+g*h*r,v=Math.atan2(u,r),t=Math.asin(g*h*
s/u),w=Math.cos(t)*Math.cos(t),s=r-2*j*n/w,y=c/16*w*(4+c*(4-3*w)),q=p,p=f+(1-y)*c*Math.sin(t)*(v+y*u*(s+y*r*(-1+2*s*s)))}if(0==m)return NaN;d=w*(d*d-e*e)/(e*e);c=d/1024*(256+d*(-128+d*(74-47*d)));return(e*(1+d/16384*(4096+d*(-768+d*(320-175*d))))*(v-c*u*(s+c/4*(r*(-1+2*s*s)-c/6*s*(-3+4*u*u)*(-3+4*s*s))))).toFixed(3)/1E3};
OpenLayers.Util.destinationVincenty=function(a,b,c){for(var d=OpenLayers.Util,e=d.VincentyConstants,f=e.a,g=e.b,h=e.f,e=a.lon,a=a.lat,j=d.rad(b),b=Math.sin(j),j=Math.cos(j),a=(1-h)*Math.tan(d.rad(a)),n=1/Math.sqrt(1+a*a),p=a*n,q=Math.atan2(a,j),a=n*b,m=1-a*a,f=m*(f*f-g*g)/(g*g),s=1+f/16384*(4096+f*(-768+f*(320-175*f))),r=f/1024*(256+f*(-128+f*(74-47*f))),f=c/(g*s),u=2*Math.PI;1E-12<Math.abs(f-u);)var v=Math.cos(2*q+f),t=Math.sin(f),w=Math.cos(f),y=r*t*(v+r/4*(w*(-1+2*v*v)-r/6*v*(-3+4*t*t)*(-3+4*v*
v))),u=f,f=c/(g*s)+y;c=p*t-n*w*j;g=Math.atan2(p*w+n*t*j,(1-h)*Math.sqrt(a*a+c*c));b=Math.atan2(t*b,n*w-p*t*j);j=h/16*m*(4+h*(4-3*m));v=b-(1-j)*h*a*(f+j*t*(v+j*w*(-1+2*v*v)));Math.atan2(a,-c);return new OpenLayers.LonLat(e+d.deg(v),d.deg(g))};
...
(function(){function a(a){a.x=180*a.x/d;a.y=180/Math.PI*(2*Math.atan(Math.exp(a.y/d*Math.PI))-Math.PI/2);return a}function b(a){a.x=a.x*d/180;var b=Math.log(Math.tan((90+a.y)*Math.PI/360))/Math.PI*d;a.y=Math.max(-2.003750834E7,Math.min(b,2.003750834E7));return a}function c(c,d){var e=OpenLayers.Projection.addTransform,f=OpenLayers.Projection.nullTransform,g,m,s,r,u;g=0;for(m=d.length;g<m;++g){s=d[g];e(c,s,b);e(s,c,a);for(u=g+1;u<m;++u)r=d[u],e(s,r,f),e(r,s,f)}}var d=2.003750834E7,e=["EPSG:900913",
...
q=0;do{var m=this.grid[q];m||(m=[],this.grid.push(m));var s=0;do{var n=this.getTileBoundsForGridIndex(q,s),r=p.clone();r.x+=s*Math.round(d);r.y+=q*Math.round(f);var u=m[s];u?u.moveTo(n,r,!1):(u=this.addTile(n,r),this.addTileMonitoringHooks(u),m.push(u));r=n.getCenterLonLat();e.push({tile:u,distance:Math.pow(r.lon-j.lon,2)+Math.pow(r.lat-j.lat,2)});s+=1}while(n.right<=a.right+c*this.buffer||s<b);q+=1}while(n.bottom>=a.bottom-h*this.buffer||q<g);this.removeExcessTiles(q,s);this.gridResolution=d=this.getServerResolution();
...
e,f,g,h,j,n,p,q=0,m=d.length;a:for(;q<m;++q){c=d[q];e=c.x1;f=c.x2;g=c.y1;h=c.y2;var s=0,r=a.length;for(;s<r;++s){j=a[s];if(j.x1>f)break;if(!(j.x2<e)&&(n=j.y1,p=j.y2,!(Math.min(n,p)>Math.max(g,h))&&!(Math.max(n,p)<Math.min(g,h))&&OpenLayers.Geometry.segmentsIntersect(c,j))){b=!0;break a}}}}else b=a.intersects(this);return b},getSortedSegments:function(){for(var a=this.components.length-1,b=Array(a),c,d,e=0;e<a;++e)c=this.components[e],d=this.components[e+1],b[e]=c.x<d.x?{x1:c.x,y1:c.y,x2:d.x,y2:d.y}:
{x1:d.x,y1:d.y,x2:c.x,y2:c.y};return b.sort(function(a,b){return a.x1-b.x1})},splitWithSegment:function(a,b){for(var c=!(b&&!1===b.edge),d=b&&b.tolerance,e=[],f=this.getVertices(),g=[],h=[],j=!1,n,p,q,m={point:!0,tolerance:d},s=null,r=0,u=f.length-2;r<=u;++r)if(d=f[r],g.push(d.clone()),n=f[r+1],p={x1:d.x,y1:d.y,x2:n.x,y2:n.y},p=OpenLayers.Geometry.segmentsIntersect(a,p,m),p instanceof OpenLayers.Geometry.Point&&((q=p.x===a.x1&&p.y===a.y1||p.x===a.x2&&p.y===a.y2||p.equals(d)||p.equals(n)?!0:!1)||c))p.equals(h[h.length-
1])||h.push(p.clone()),!(0===r&&p.equals(d))&&!p.equals(n)&&(j=!0,p.equals(d)||g.push(p),e.push(new OpenLayers.Geometry.LineString(g)),g=[p.clone()]);j&&(g.push(n.clone()),e.push(new OpenLayers.Geometry.LineString(g)));if(0<h.length)var v=a.x1<a.x2?1:-1,t=a.y1<a.y2?1:-1,s={lines:e,points:h.sort(function(a,b){return v*a.x-v*b.x||t*a.y-t*b.y})};return s},split:function(a,b){var c=null,d=b&&b.mutual,e,f,g,h;if(a instanceof OpenLayers.Geometry.LineString){var j=this.getVertices(),n,p,q,m,s,r=[];g=[];
for(var u=0,v=j.length-2;u<=v;++u){n=j[u];p=j[u+1];q={x1:n.x,y1:n.y,x2:p.x,y2:p.y};h=h||[a];d&&r.push(n.clone());for(var t=0;t<h.length;++t)if(m=h[t].splitWithSegment(q,b))if(s=m.lines,0<s.length&&(s.unshift(t,1),Array.prototype.splice.apply(h,s),t+=s.length-2),d)for(var w=0,y=m.points.length;w<y;++w)s=m.points[w],s.equals(n)||(r.push(s),g.push(new OpenLayers.Geometry.LineString(r)),r=s.equals(p)?[]:[s.clone()])}d&&(0<g.length&&0<r.length)&&(r.push(p.clone()),g.push(new OpenLayers.Geometry.LineString(r)))}else c=
a.splitWith(this,b);h&&1<h.length?f=!0:h=[];g&&1<g.length?e=!0:g=[];if(f||e)c=d?[g,h]:h;return c},splitWith:function(a,b){return a.split(this,b)},getVertices:function(a){return!0===a?[this.components[0],this.components[this.components.length-1]]:!1===a?this.components.slice(1,this.components.length-1):this.components.slice()},distanceTo:function(a,b){var c=!(b&&!1===b.edge)&&b&&b.details,d,e={},f=Number.POSITIVE_INFINITY;if(a instanceof OpenLayers.Geometry.Point){for(var g=this.getSortedSegments(),
h=a.x,j=a.y,n,p=0,q=g.length;p<q;++p)if(n=g[p],d=OpenLayers.Geometry.distanceToSegment(a,n),d.distance<f){if(f=d.distance,e=d,0===f)break}else if(n.x2>h&&(j>n.y1&&j<n.y2||j<n.y1&&j>n.y2))break;e=c?{distance:e.distance,x0:e.x,y0:e.y,x1:h,y1:j}:e.distance}else if(a instanceof OpenLayers.Geometry.LineString){var g=this.getSortedSegments(),h=a.getSortedSegments(),m,s,r=h.length,u={point:!0},p=0,q=g.length;a:for(;p<q;++p){j=g[p];n=j.x1;s=j.y1;for(var v=0;v<r;++v)if(d=h[v],m=OpenLayers.Geometry.segmentsIntersect(j,
d,u)){f=0;e={distance:0,x0:m.x,y0:m.y,x1:m.x,y1:m.y};break a}else d=OpenLayers.Geometry.distanceToSegment({x:n,y:s},d),d.distance<f&&(f=d.distance,e={distance:f,x0:n,y0:s,x1:d.x,y1:d.y})}c||(e=e.distance);0!==f&&j&&(d=a.distanceTo(new OpenLayers.Geometry.Point(j.x2,j.y2),b),p=c?d.distance:d,p<f&&(e=c?{distance:f,x0:d.x1,y0:d.y1,x1:d.x0,y1:d.y0}:p))}else e=a.distanceTo(this,b),c&&(e={distance:e.distance,x0:e.x1,y0:e.y1,x1:e.x0,y1:e.y0});return e},simplify:function(a){if(this&&null!==this){var b=this.getVertices();
if(3>b.length)return this;var c=function(a,b,d,j){for(var n=0,p=0,q=b,m;q<d;q++){m=a[b];var s=a[d],r=a[q],r=Math.abs(0.5*(m.x*s.y+s.x*r.y+r.x*m.y-s.x*m.y-r.x*s.y-m.x*r.y));m=Math.sqrt(Math.pow(m.x-s.x,2)+Math.pow(m.y-s.y,2));m=2*(r/m);m>n&&(n=m,p=q)}n>j&&p!=b&&(e.push(p),c(a,b,p,j),c(a,p,d,j))},d=b.length-1,e=[];e.push(0);for(e.push(d);b[0].equals(b[d]);)d--,e.push(d);c(b,0,d,a);a=[];e.sort(function(a,b){return a-b});for(d=0;d<e.length;d++)a.push(b[e[d]]);return new OpenLayers.Geometry.LineString(a)}return this},
CLASS_NAME:"OpenLayers.Geometry.LineString"});
OpenLayers.Geometry.MultiLineString=OpenLayers.Class(OpenLayers.Geometry.Collection,{componentTypes:["OpenLayers.Geometry.LineString"],split:function(a,b){for(var c=null,d=b&&b.mutual,e,f,g,h,j=[],n=[a],p=0,q=this.components.length;p<q;++p){f=this.components[p];g=!1;for(var m=0;m<n.length;++m)if(e=f.split(n[m],b)){if(d){g=e[0];for(var s=0,r=g.length;s<r;++s)0===s&&j.length?j[j.length-1].addComponent(g[s]):j.push(new OpenLayers.Geometry.MultiLineString([g[s]]));g=!0;e=e[1]}if(e.length){e.unshift(m,
...
1),Array.prototype.splice.apply(j,g),m+=g.length-2),e=e[1],0===e.length&&(e=[f.clone()]));g=0;for(var s=e.length;g<s;++g)0===g&&n.length?n[n.length-1].addComponent(e[g]):n.push(new OpenLayers.Geometry.MultiLineString([e[g]]));g=!0}g||(n.length?n[n.length-1].addComponent(f.clone()):n=[new OpenLayers.Geometry.MultiLineString([f.clone()])])}}else c=a.split(this);j&&1<j.length?h=!0:j=[];n&&1<n.length?g=!0:n=[];if(h||g)c=d?[j,n]:n;return c},CLASS_NAME:"OpenLayers.Geometry.MultiLineString"});
...
OpenLayers.Control.ModifyFeature.ROTATE;b.move=function(b,c){OpenLayers.Geometry.Point.prototype.move.call(this,b,c);var n=this.x-d.x,p=this.y-d.y,q=n-b,m=p-c;if(g){var s=Math.atan2(m,q),s=Math.atan2(p,n)-s,s=s*(180/Math.PI);a.rotate(s,d)}if(e){var r;f?(p/=m,r=n/q/p):(q=Math.sqrt(q*q+m*m),p=Math.sqrt(n*n+p*p)/q);a.resize(p,d,r)}};c._sketch=!0;this.radiusHandle=c;this.radiusHandle.renderIntent=this.vertexRenderIntent;this.layer.addFeatures([this.radiusHandle],{silent:!0})},setMap:function(a){this.handlers.drag.setMap(a);
...
(e=new window.ActiveXObject("Microsoft.XMLDOM"),e.async=!1,e.validateOnParse=!1,e.loadXML(f));c=e&&(h&&0!=e.parseError||!e.documentElement||e.documentElement&&"parsererror"==e.documentElement.tagName)?null:e;a.responseXML=c}catch(g){}try{a.status=a._object.status}catch(j){}try{a.statusText=a._object.statusText}catch(t){}}function e(a){a._object.onreadystatechange=new window.Function}var f=window.XMLHttpRequest,g=!!window.controllers,h=window.document.all&&!window.opera,j=h&&window.navigator.userAgent.match(/MSIE 7.0/);
b.prototype=a.prototype;g&&f.wrapped&&(b.wrapped=f.wrapped);b.UNSENT=0;b.OPENED=1;b.HEADERS_RECEIVED=2;b.LOADING=3;b.DONE=4;b.prototype.readyState=b.UNSENT;b.prototype.responseText="";b.prototype.responseXML=null;b.prototype.status=0;b.prototype.statusText="";b.prototype.priority="NORMAL";b.prototype.onreadystatechange=null;b.onreadystatechange=null;b.onopen=null;b.onsend=null;b.onabort=null;b.prototype.open=function(a,f,j,m,s){delete this._headers;3>arguments.length&&(j=!0);this._async=j;var r=this,
u=this.readyState,v;h&&j&&(v=function(){u!=b.DONE&&(e(r),r.abort())},window.attachEvent("onunload",v));b.onopen&&b.onopen.apply(this,arguments);4<arguments.length?this._object.open(a,f,j,m,s):3<arguments.length?this._object.open(a,f,j,m):this._object.open(a,f,j);this.readyState=b.OPENED;c(this);this._object.onreadystatechange=function(){if(!g||j)r.readyState=r._object.readyState,d(r),r._aborted?r.readyState=b.UNSENT:(r.readyState==b.DONE&&(delete r._data,e(r),h&&j&&window.detachEvent("onunload",v)),
u!=r.readyState&&c(r),u=r.readyState)}};b.prototype.send=function(a){b.onsend&&b.onsend.apply(this,arguments);arguments.length||(a=null);a&&a.nodeType&&(a=window.XMLSerializer?(new window.XMLSerializer).serializeToString(a):a.xml,this._headers["Content-Type"]||this._object.setRequestHeader("Content-Type","application/xml"));this._data=a;a:if(this._object.send(this._data),g&&!this._async){this.readyState=b.OPENED;for(d(this);this.readyState<b.DONE;)if(this.readyState++,c(this),this._aborted)break a}};
...
m;q++){var s=d.dimensions[q];n.push(s.identifier);p.hasOwnProperty(s.identifier)||(p[s.identifier]=s["default"])}var q=b.projection||h.supportedCRS.replace(/urn:ogc:def:crs:(\w+):(.*:)?(\w+)$/,"$1:$3"),m=b.units||("EPSG:4326"===q?"degrees":"m"),s=[],r;for(r in h.matrixIds)h.matrixIds.hasOwnProperty(r)&&s.push(2.8E-4*h.matrixIds[r].scaleDenominator/OpenLayers.METERS_PER_INCH/OpenLayers.INCHES_PER_UNIT[m]);if("REST"===c&&d.resourceUrls){r=[];for(var f=0,u=d.resourceUrls.length;f<u;++f)e=d.resourceUrls[f],
e.format===g&&"tile"===e.resourceType&&r.push(e.template)}else{u=a.operationsMetadata.GetTile.dcp.http.get;r=[];for(var v,e=0,f=u.length;e<f;e++)v=u[e].constraints,(!v||v&&v.GetEncoding.allowedValues[c])&&r.push(u[e].url)}return new OpenLayers.Layer.WMTS(OpenLayers.Util.applyDefaults(b,{url:r,requestEncoding:c,name:d.title,style:j.identifier,format:g,matrixIds:h.matrixIds,matrixSet:h.identifier,projection:q,units:m,resolutions:!1===b.isBaseLayer?void 0:s,serverResolutions:s,tileFullExtent:h.bounds,
...
b);var c=this.getResolution(),d=[],e,f,g,h,j,n,p,q,m,s;e=0;for(f=b.components.length;e<f;e++){d.push("m");g=b.components[e].components;h=0===e;n=j=null;p=0;for(q=g.length;p<q;p++)m=g[p],s=(m.x-this.featureDx)/c-this.offset.x|0,m=m.y/c-this.offset.y|0,s=" "+s+","+m,d.push(s),0==p&&d.push(" l"),h||(j?j!=s&&(n?n!=s&&(h=!0):n=s):j=s);d.push(h?" x ":" ")}d.push("e");a.path=d.join("");return a},drawRectangle:function(a,b){var c=this.getResolution();a.style.left=((b.x-this.featureDx)/c-this.offset.x|0)+
...
a.features?a.features.length:0,c=Array(b),e=0;e<b;++e)c[e]=a.features[e].fid;r.insertIds=c;d.apply(this,[a])}function d(a){this.callUserCallback(a,b);s=s&&a.success();f++;f>=m&&b.callback&&(r.code=s?OpenLayers.Protocol.Response.SUCCESS:OpenLayers.Protocol.Response.FAILURE,b.callback.apply(b.scope,[r]))}var b=OpenLayers.Util.applyDefaults(b,this.options),e=[],f=0,g={};g[OpenLayers.State.INSERT]=[];g[OpenLayers.State.UPDATE]=[];g[OpenLayers.State.DELETE]=[];for(var h,j,n=[],p=0,q=a.length;p<q;++p)if(h=
a[p],j=g[h.state])j.push(h),n.push(h);var m=(0<g[OpenLayers.State.INSERT].length?1:0)+g[OpenLayers.State.UPDATE].length+g[OpenLayers.State.DELETE].length,s=!0,r=new OpenLayers.Protocol.Response({reqFeatures:n});h=g[OpenLayers.State.INSERT];0<h.length&&e.push(this.create(h,OpenLayers.Util.applyDefaults({callback:c,scope:this},b.create)));h=g[OpenLayers.State.UPDATE];for(p=h.length-1;0<=p;--p)e.push(this.update(h[p],OpenLayers.Util.applyDefaults({callback:d,scope:this},b.update)));h=g[OpenLayers.State.DELETE];
...
b.Plugins.LayersManager;return a&&a._o&&a._o.userInfo?a._o.userInfo:{userid:-1}},extendUrl:function(a,b){var c,d,e,f,g,r={},u="",v=a.split("?")[0];try{g=a.split("?")[1].split("&")}catch(t){g=[]}e=0;for(f=g.length;e<f;e++)c=g[e].split("=")[0],d=g[e].split("=")[1],c&&d&&(r[c]=d);b=$.extend(r,b);for(c in b)null!==b[c]&&(u+=c+"="+b[c]+"&");return v+"?"+u},showPopupImage:function(c,d){var e=new b.Popup({modal:!0,resize:!1,autoSize:!0,noHeader:!0}),f=new Image;b.activity.show();e.hide();e.$m.show();f.src=
c;$(f).load(function(){var g=[f.width,f.height,0.8*a.innerWidth,0.8*a.innerHeight],m=g[0],s=g[1];s>g[3]&&(s=g[3],m=m*s/g[1]);m>g[2]&&(m=g[2],s=s*m/g[0]);e.$b.html('<div class="imageContent"><div class="padded"><img src="'+c+'" height="'+s+'" width="'+m+'"/><div class="innerTitle" style="width:'+m+'px;">'+d+"</div></div></div>");e.$d.css({left:(a.innerWidth-e.$d.width())/2,top:0});b.activity.hide();e.show()}).error(function(){b.activity.hide();e.hide();b.Util.message("Error loading image")})},showPopupVideo:function(c){var d,
...
d.remove();f()});d.css({left:(b.$container.width()-d.width())/2,top:30});return d},encode:function(a){return!a?a:a.replace(/[',", ,\.,#,\:,\ ]/g,"_")},extractBaseUrl:function(a,b){var c;c=this.repareUrl(a);if(!c)return null;c=c.match(/.+\?/)[0];if(!b||0===b.length)return c;var d,e,f,g,r=this.extractKVP(a,!0);for(e in r){d=!0;f=0;for(g=b.length;f<g;f++)if(e===b[f]){d=!1;break}d&&(c+=encodeURIComponent(e)+"="+encodeURIComponent(r[e])+"&")}return c},extractKVP:function(a,b){var c={};(a||"").replace(/[?&]+([^=&]+)=([^&]*)/gi,
...
!d||!d.length||!d[0].childNodes.length?e:null;e=new ActiveXObject("Microsoft.XMLDOM");e.async=!1;e.loadXML(b);return e}catch(f){return null}},lowerFirstLetter:function(a){return a.charAt(0).toLowerCase()+a.slice(1)},upload:function(a,c){var d,e,f,g=[],s=this,c=c||{};$.isArray(a)||(a=[a]);b.mask.add({title:this._("Upload files")+"...",cancel:!1});$(a).each(function(a,d){if(!s.isSupportedMimeType(c.formats,d.type))return s.message(b.Util._("Error : mimeType is not supported")+" ["+d.type+"]"),!1;if(d.size/
1048576>c.maximumMegabytes)return s.message(b.Util._("Error : file is to big")+" ["+d.name+"]"),!1;g.push(d);return!0});if(0<g.length){$.get("./blank.html");var r=new XMLHttpRequest;r.onreadystatechange=function(){var a;if(4===r.readyState&&(200===r.status||0===r.status))b.mask.hide(),a=JSON.parse(r.responseText),a.error?b.Util.message(a.error.message):a.items&&$.isFunction(c.callback)&&c.callback(a.items)};if("undefined"!==typeof FormData){f=new FormData;f.append("path","/");d=0;for(e=a.length;d<
e;d++)f.append("file[]",a[d]);r.open("POST",b.Util.getAbsoluteUrl(b.Config.upload.serviceUrl)+b.Util.abc+"&magic=true");r.send(f)}else b.Util.message("Error : your browser does not support HTML5 Drag and Drop")}else b.Util.message("Error : this file type is not allowed"),b.mask.hide()}}})(window,window.M,window.document);
...
(function(a,b){b.layerTypes.WMTS={isRaster:!0,icon:"wms.png",mandatories:["layer","matrixSet"],add:function(b,d){var e,f=b.matrixLength||22,g=Array(f);b.url=a.Util.repareUrl(b.url);if(!b.matrixIds)for(e=0;e<=f;++e)g[e]=(b.prefixMatrix?b.prefixMatrix:"")+e;$.extend(d,{name:b.title,url:b.url,layer:b.layer,matrixSet:b.matrixSet,matrixIds:b.matrixIds?b.matrixIds:g,maxZoomLevel:f,format:b.format||"image/png",style:b.style||"normal",version:"1.0.0",wrapDateLine:!0,isBaseLayer:a.Util.getPropertyValue(b,
"isBaseLayer",!1),attribution:b.attribution||null});b.time&&b.time.hasOwnProperty("default")&&(d.time=b.time["default"]);var h=new OpenLayers.Layer.WMTS(d);b.hasOwnProperty("time")&&(h._M.setTime=function(a){a=$.isArray(a)?a[0]:"";a=a.split("T")[0];this.layerDescription.time&&(this.layerDescription.time=this.layerDescription.time||{},this.layerDescription.time.value=a,h.mergeNewParams({TIME:a}))});return h},getMID:function(b){return b.MID||a.Util.crc32(b.type+(a.Util.repareUrl(b.url)||"")+(b.layer||
"")+(b.matrixSet||""))}}})(window.M,window.M.Map);
...
(function(a){a.Plugins.Navigation=function(){if(a.Plugins.Navigation._o)return a.Plugins.Navigation._o;this.init=function(b){var c=this;c.options=b||{};$.extend(c.options,{home:a.Util.getPropertyValue(c.options,"home",{lon:0,lat:40,zoom:2}),zoomin:a.Util.getPropertyValue(c.options,"zoomin",!0),zoomout:a.Util.getPropertyValue(c.options,"zoomout",!0),position:a.Util.getPropertyValue(c.options,"position","nw"),orientation:a.Util.getPropertyValue(c.options,"orientation","v")});tb=new a.Toolbar({position:c.options.position,
orientation:c.options.orientation});c.options.zoomin&&tb.add({title:"+",tt:"Zoom",onoff:!1,onactivate:function(b,c){c.activate(!1);a.Map.map.setCenter(a.Map.map.getCenter(),a.Map.map.getZoom()+1)}});c.options.zoomout&&tb.add({title:"-",tt:"Zoom out",onoff:!1,onactivate:function(b,c){c.activate(!1);a.Map.map.setCenter(a.Map.map.getCenter(),Math.max(a.Map.map.getZoom()-1,a.Map.lowestZoomLevel))}});c.options.home&&tb.add({title:"&#8226;",tt:"Global view",onoff:!1,onactivate:function(b,e){e.activate(!1);
a.Map.map.restrictedExtent?a.Map.map.zoomToExtent(a.Map.map.restrictedExtent):a.Map.setCenter(a.Map.Util.d2p(new OpenLayers.LonLat(c.options.home.lon,c.options.home.lat)),c.options.home.zoom,!0)}});return this};a.Plugins.Navigation._o=this;return this}})(window.M);
