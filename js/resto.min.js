(function(d){d.R=d.R||{};d.R={VERSION_NUMBER:"RESTo 1.0",issuer:"getCollection",translation:{},restoUrl:null,layer:null,ssoServices:{},userProfile:null,userRights:null,language:"en",init:function(a){var b,c=this,a=a||{};c.translation=a.translation||{};c.restoUrl=a.restoUrl;c.issuer=a.issuer;c.language=a.language||"en";c.ssoServices=a.ssoServices||{};if(d.M&&($("#resto-container").bind("scroll",function(){clearTimeout(b);b=setTimeout(function(){d.M.events.trigger("resizeend")},150)}),a.data))var e=
setInterval(function(){d.M.Map.map&&d.M.isLoaded&&(c.initSearchLayer(a.data,!0),"getResource"===c.issuer&&c.layer&&(d.M.Map.zoomTo(c.layer.getDataExtent(),!1),c.userRights&&c.userRights.visualize&&$.isArray(a.data.features)&&a.data.features[0]&&a.data.features[0].properties.services.browse&&a.data.features[0].properties.services.browse.layer&&M.Map.addLayer({title:a.data.features[0].id,type:a.data.features[0].properties.services.browse.layer.type,layers:a.data.features[0].properties.services.browse.layer.layers,
url:a.data.features[0].properties.services.browse.layer.url.replace("%5C","")})),(new M.Toolbar({position:"nw",orientation:"h"})).add({title:'<span class="fa fa-map-marker"></span>',tt:"Center",onoff:!1,onactivate:function(a,b){b.activate(!1);c.layer&&(c.layer.features&&0<c.layer.features.length)&&d.M.Map.zoomTo(c.layer.getDataExtent(),!1)}}),clearInterval(e))},500);if(d.M)var g=setInterval(function(){d.M.Map.map&&d.M.isLoaded&&(d.M.Map.events.register("moveend",c,function(a,c){c.updateBBOX()}),c.updateBBOX(),
clearInterval(g))},500);$("#resto-searchform").submit(function(a){a.preventDefault();d.History.pushState({randomize:d.Math.random()},null,"?"+$(this).serialize()+(d.M&&$("#mapshup").visible()?"&box="+d.M.Map.Util.p2d(M.Map.map.getExtent()).toBBOX():""))});$("#searchsubmit").click(function(a){a.preventDefault();$("#resto-searchform").submit()});c.updateRestoToolbar();c.Admin.updateAdminActions(a.collection);$("#search").focus();if("getCollection"===c.issuer)c.onHistoryChange(c.updateGetCollection);
c.ajax({url:c.restoUrl+"auth/getProfile.php",dataType:"json",success:function(b){c.userProfile=b;c.userRights=c.userProfile.collections&&c.userProfile.collections[c.collection]?$.extend(c.userProfile.rights["default"],c.userProfile.collections[c.collection]):c.userProfile.rights["default"];"getCollection"===c.issuer&&c.updateGetCollection(a.data,{updateMap:!1,centerMap:a.data&&a.data.query});c.updateConnectionInfo();c.hideMask()},error:function(){c.hideMask()}})},onHistoryChange:function(a){var b=
this;d.History.Adapter.bind(d,"statechange",function(){var c=d.History.getState(),e=b.updateURL(c.cleanUrl,{format:"json"});b.showMask();$.ajax({url:e,async:!0,dataType:"json",success:function(e){b.hideMask();"function"===typeof a&&a(e,{updateMap:!0,centerMap:c.data&&c.data.centerMap||e.query&&e.query.hasLocation?!0:!1})},error:function(){b.hideMask();b.message("Connection error")}})})},sanitizeValue:function(a){return!a||!a.length?"":("string"===$.type(a)?a:a.val()).replace(/<.*?>/g,"")},updateRestoToolbar:function(){var a=
...
m=a.split("?")[0];try{f=a.split("?")[1].split("&")}catch(l){f=[]}d=0;for(h=f.length;d<h;d++)c=f[d].split("=")[0],e=f[d].split("=")[1],c&&(i[c]=e?e:"");for(c in b)i[c]=b[c];for(c in i)j+=c+"="+i[c]+"&";return m+"?"+j},addLayer:function(a){if(!d.M)return null;"string"===typeof a&&(a=JSON.parse(decodeURI(a)));return d.M.Map.addLayer(a,{noDeletionCheck:!0})},initSearchLayer:function(a,b){this.layer=this.addLayer({type:"GeoJSON",clusterized:!1,data:a,zoomOnNew:b?"always":!1,MID:"__resto__",color:"#FFF1FB",
selectable:"getCollection"===this.issuer?!0:!1,featureInfo:{noMenu:!0,onSelect:function(a){if(a&&a.fid){d.M.Map.featureInfo.unhilite(d.M.Map.featureInfo.hilited);var b=0;0<$("#mapshup-tools").length&&(b=$("#mapshup-tools").position().top+$("#mapshup-tools").height());$(".resto-entry").each(function(){if($(this).attr("fid")===a.fid)return $(this).addClass("selected"),$("html, body").animate({scrollTop:$(this).offset().top-b},500),!1})}},onUnselect:function(){$(".resto-entry").each(function(){$(this).removeClass("selected")})}},
...
g;e++)"text/html"===f.properties.links[e].type&&(l=this.updateURL(f.properties.links[e].href,{lang:this.language}))}m.append('<li><div class="resto-entry" id="rid'+b+'" fid="'+f.id+'"><div class="padded-bottom"><span class="platform">'+j+(j&&f.properties.instrument?"/"+f.properties.instrument:"")+'</span> | <span class="timestamp">'+f.properties.startDate+'</span></div><div><a href="'+l+'" title="'+this.translate("_viewMetadata",[f.id])+'"><img class="resto-image" src="'+h+'"/></a></div><div class="resto-actions"></div><div class="resto-keywords"></div></div></li>');
