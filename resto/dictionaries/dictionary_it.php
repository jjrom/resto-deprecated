...
return array(
    ...
    'translation' => array(
        ...
        '_viewMetadata' => 'Visualizzare i metadati di {a:1}',
        ...
        '_other' => 'Altro',
        '_home' => 'Home',
        '_viewAtomFeed' => 'Visualizza Atom feed',
        '_shareOn' => 'Pubblica su {a:1}',
        '_zoom' => 'Zoom mappa',
        '_unZoom' => 'Unzoom mappa',
        '_centerOnLayer' => 'Centrare la vista sul risultato della ricerca',
        '_globalMapView' => 'Centrare la vista su tutta la terra',
        '_showOnMap' => 'Vedi sulla mappa',
        '_dropCollection' => 'Drop a collection description file',
        '_email' => 'Email',
        '_password' => 'Password',
        '_createAccount' => 'Crea un account',
        '_givenName' => 'Nome',
        '_lastName' => 'Cognome',
        '_userName' => 'Nome utente',
        '_retypePassword' => 'Ripeti password',
        '_back' => 'Indietro',
        '_signWithOauth' => 'Accedi con il tuo account {a:1}',
